      ...
      if(p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
         ...
         if(i >= 0 && i < p_77912_2_) {
            ...
            if(l1 > 0) {
               ...
               int i2 = func_77912_a(p_77912_0_, i + 1, p_77912_2_, p_77912_3_);
               return i2 > 0?i2:0;
            }
         } else {
            int j = p_77912_0_.indexOf(38, p_77912_1_);
            if(j >= 0 && j < p_77912_2_) {
               int k = func_77912_a(p_77912_0_, p_77912_1_, j - 1, p_77912_3_);
               if(k <= 0) {
                  return 0;
               } else {
                  int j2 = func_77912_a(p_77912_0_, j + 1, p_77912_2_, p_77912_3_);
   ...
   public static int func_77913_a(int p_77913_0_, String p_77913_1_) {
      ...
      for(int k = b0; k < i; ++k) {
         ...
         if(c0 >= 48 && c0 <= 57) {
            ...
            if(flag) {
               p_77913_0_ = func_77906_a(p_77913_0_, j, flag2, flag1, flag3);
               flag3 = false;
               flag1 = false;
               flag2 = false;
               flag = false;
