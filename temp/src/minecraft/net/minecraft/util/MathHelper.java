...
public class MathHelper {
   ...
   public static float func_76126_a(float p_76126_0_) {
      return fastMath?SIN_TABLE_FAST[(int)(p_76126_0_ * 651.8986F) & 4095]:field_76144_a[(int)(p_76126_0_ * 10430.378F) & '\uffff'];
   }

   public static float func_76134_b(float p_76134_0_) {
      return fastMath?SIN_TABLE_FAST[(int)((p_76134_0_ + 1.5707964F) * 651.8986F) & 4095]:field_76144_a[(int)(p_76134_0_ * 10430.378F + 16384.0F) & '\uffff'];
   }
