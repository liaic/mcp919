...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   public GuiMainMenu() {
      ...
      try {
         ...
         if(!arraylist.isEmpty()) {
            while(true) {
               this.field_73975_c = (String)arraylist.get(field_175374_h.nextInt(arraylist.size()));
   ...
   private void func_73969_a(int p_73969_1_, int p_73969_2_) {
      ...
      if(Reflector.GuiModList_Constructor.exists()) {
         ...
         this.field_146292_n.add(this.modButton = new GuiButton(6, this.field_146294_l / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.func_135052_a("fml.menu.mods", new Object[0])));
      } else {
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      ...
      if(p_146284_1_.field_146127_k == 6 && Reflector.GuiModList_Constructor.exists()) {
         this.field_146297_k.func_147108_a((GuiScreen)Reflector.newInstance(Reflector.GuiModList_Constructor, new Object[]{this}));
      }
   ...
   private void func_73970_b(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         for(int k = 0; k < 6; ++k) {
            ...
            ResourceLocation[] aresourcelocation = field_73978_o;
            if(custompanoramaproperties != null) {
               aresourcelocation = custompanoramaproperties.getPanoramaLocations();
            }

            this.field_146297_k.func_110434_K().func_110577_a(aresourcelocation[k]);
   ...
   private void func_73971_c(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
      ...
      float f = (float)this.field_146295_m * f2 / 256.0F;
      float f1 = (float)this.field_146294_l * f2 / 256.0F;
      int k = this.field_146294_l;
      int l = this.field_146295_m;
      Tessellator tessellator = Tessellator.func_178181_a();
      WorldRenderer worldrenderer = tessellator.func_178180_c();
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      worldrenderer.func_181662_b(0.0D, (double)l, (double)this.field_73735_i).func_181673_a((double)(0.5F - f), (double)(0.5F + f1)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b((double)k, (double)l, (double)this.field_73735_i).func_181673_a((double)(0.5F - f), (double)(0.5F - f1)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b((double)k, 0.0D, (double)this.field_73735_i).func_181673_a((double)(0.5F + f), (double)(0.5F - f1)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b(0.0D, 0.0D, (double)this.field_73735_i).func_181673_a((double)(0.5F + f), (double)(0.5F + f1)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      tessellator.func_78381_a();
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      WorldRenderer worldrenderer = tessellator.func_178180_c();
      short short1 = 274;
      int i = this.field_146294_l / 2 - short1 / 2;
      byte b0 = 30;
      int j = -2130706433;
      int k = 16777215;
      int l = 0;
      ...
      this.func_73733_a(0, 0, this.field_146294_l, this.field_146295_m, j, k);
      this.func_73733_a(0, 0, this.field_146294_l, this.field_146295_m, l, i1);
      this.field_146297_k.func_110434_K().func_110577_a(field_110352_y);
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      if((double)this.field_73974_b < 1.0E-4D) {
         this.func_73729_b(i + 0, b0 + 0, 0, 0, 99, 44);
         this.func_73729_b(i + 99, b0 + 0, 129, 0, 27, 44);
         this.func_73729_b(i + 99 + 26, b0 + 0, 126, 0, 3, 44);
         this.func_73729_b(i + 99 + 26 + 3, b0 + 0, 99, 0, 26, 44);
         this.func_73729_b(i + 155, b0 + 0, 0, 45, 155, 44);
      } else {
         this.func_73729_b(i + 0, b0 + 0, 0, 0, 155, 44);
         this.func_73729_b(i + 155, b0 + 0, 0, 45, 155, 44);
      }
      ...
      if(Reflector.FMLCommonHandler_getBrandings.exists()) {
         ...
         for(int j1 = 0; j1 < list.size(); ++j1) {
            ...
            if(!Strings.isNullOrEmpty(s1)) {
               this.func_73731_b(this.field_146289_q, s1, 2, this.field_146295_m - (10 + j1 * (this.field_146289_q.field_78288_b + 1)), 16777215);
            }
         }

         if(Reflector.ForgeHooksClient_renderMainMenu.exists()) {
            Reflector.call(Reflector.ForgeHooksClient_renderMainMenu, new Object[]{this, this.field_146289_q, Integer.valueOf(this.field_146294_l), Integer.valueOf(this.field_146295_m)});
         }
      } else {
      ...
      this.func_73731_b(this.field_146289_q, s2, this.field_146294_l - this.field_146289_q.func_78256_a(s2) - 2, this.field_146295_m - 10, -1);
