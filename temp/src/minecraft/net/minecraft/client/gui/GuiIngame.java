...
public class GuiIngame extends Gui {
   ...
   public void func_175180_a(float p_175180_1_) {
      ...
      GlStateManager.func_179147_l();
      if(this.func_175183_b() && this.field_73839_d.field_71474_y.field_74320_O < 1) {
      ...
      if(this.field_73839_d.field_71439_g.func_71060_bI() > 0) {
         ...
         int l = this.field_73839_d.field_71439_g.func_71060_bI();
      ...
      if(this.field_73839_d.field_71439_g.func_110317_t()) {
         this.func_175186_a(scaledresolution, i2);
      } else if(this.field_73839_d.field_71442_b.func_78763_f()) {
         this.func_175176_b(scaledresolution, i2);
      }
      ...
      if(this.field_73845_h > 0) {
         ...
         if(k1 > 8) {
            ...
            this.func_175179_f().func_78276_b(this.field_73838_g, -this.func_175179_f().func_78256_a(this.field_73838_g) / 2, -4, i1 + (k1 << 24 & -16777216));
            GlStateManager.func_179084_k();
      ...
      if(this.field_175195_w > 0) {
         ...
         l1 = MathHelper.func_76125_a(l1, 0, 255);
         if(l1 > 8) {
            GlStateManager.func_179094_E();
      ...
      if(scoreplayerteam != null) {
         int j1 = scoreplayerteam.func_178775_l().func_175746_b();
         if(j1 >= 0) {
            scoreobjective = scoreboard.func_96539_a(3 + j1);
         }
      }
   ...
   public void func_175186_a(ScaledResolution p_175186_1_, int p_175186_2_) {
      ...
      int j = p_175186_1_.func_78328_b() - 32 + 3;
      this.func_73729_b(p_175186_2_, j, 0, 84, short1, 5);
      if(i > 0) {
         this.func_73729_b(p_175186_2_, j, 0, 89, i, 5);
      }
   ...
   public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_) {
      ...
      if(i > 0) {
         short short1 = 182;
         int k = (int)(this.field_73839_d.field_71439_g.field_71106_cc * (float)(short1 + 1));
         int j = p_175176_1_.func_78328_b() - 32 + 3;
         this.func_73729_b(p_175176_2_, j, 0, 64, short1, 5);
         if(k > 0) {
            this.func_73729_b(p_175176_2_, j, 0, 69, k, 5);
         }
      }
      ...
      if(this.field_73839_d.field_71439_g.field_71068_ca > 0) {
         ...
         int l = p_175176_1_.func_78328_b() - 31 - 4;
         boolean flag = false;
         this.func_175179_f().func_78276_b(s, i1 + 1, l, 0);
         this.func_175179_f().func_78276_b(s, i1 - 1, l, 0);
         this.func_175179_f().func_78276_b(s, i1, l + 1, 0);
         this.func_175179_f().func_78276_b(s, i1, l - 1, 0);
         this.func_175179_f().func_78276_b(s, i1, l, j1);
         this.field_73839_d.field_71424_I.func_76319_b();
      }
   ...
   private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      ...
      int j1 = arraylist1.size() * this.func_175179_f().field_78288_b;
      int k1 = p_180475_2_.func_78328_b() / 2 + j1 / 3;
      byte b0 = 3;
      int j = p_180475_2_.func_78326_a() - i - b0;
      int k = 0;
      ...
      for(Score score1 : arraylist1) {
         ...
         int i1 = p_180475_2_.func_78326_a() - b0 + 2;
         func_73734_a(j - 2, l, i1, l + this.func_175179_f().field_78288_b, 1342177280);
         this.func_175179_f().func_78276_b(s1, j, l, 553648127);
         this.func_175179_f().func_78276_b(s2, i1 - this.func_175179_f().func_78256_a(s2), l, 553648127);
         if(k == arraylist1.size()) {
            String s3 = p_180475_1_.func_96678_d();
            func_73734_a(j - 2, l - this.func_175179_f().field_78288_b - 1, i1, l - 1, 1610612736);
            func_73734_a(j - 2, l - 1, i1, l, 1342177280);
            this.func_175179_f().func_78276_b(s3, j + i / 2 - this.func_175179_f().func_78256_a(s3) / 2, l - this.func_175179_f().field_78288_b, 553648127);
         }
      }
   ...
   private void func_180477_d(ScaledResolution p_180477_1_) {
      if(this.field_73839_d.func_175606_aa() instanceof EntityPlayer) {
         ...
         for(int j5 = MathHelper.func_76123_f((f + f1) / 2.0F) - 1; j5 >= 0; --j5) {
            int k5 = 16;
            ...
            int k3 = MathHelper.func_76123_f((float)(j5 + 1) / 10.0F) - 1;
            int l3 = i1 + j5 % 10 * 8;
            int i4 = k1 - k3 * i2;
            if(i <= 4) {
               i4 += this.field_73842_c.nextInt(2);
            }
            ...
            this.func_73729_b(l3, i4, 16 + b0 * 9, 9 * b1, 9, 9);
            if(flag) {
               if(j5 * 2 + 1 < j) {
                  this.func_73729_b(l3, i4, k5 + 54, 9 * b1, 9, 9);
               }

               if(j5 * 2 + 1 == j) {
                  this.func_73729_b(l3, i4, k5 + 63, 9 * b1, 9, 9);
               }
            }

            if(f2 <= 0.0F) {
               if(j5 * 2 + 1 < i) {
                  this.func_73729_b(l3, i4, k5 + 36, 9 * b1, 9, 9);
               }

               if(j5 * 2 + 1 == i) {
                  this.func_73729_b(l3, i4, k5 + 45, 9 * b1, 9, 9);
               }
            } else {
               if(f2 == f1 && f1 % 2.0F == 1.0F) {
                  this.func_73729_b(l3, i4, k5 + 153, 9 * b1, 9, 9);
               } else {
                  this.func_73729_b(l3, i4, k5 + 144, 9 * b1, 9, 9);
               }
         ...
         if(entity == null) {
            ...
            for(int l5 = 0; l5 < 10; ++l5) {
               ...
               if(entityplayer.func_71024_bL().func_75115_e() <= 0.0F && this.field_73837_f % (k * 3 + 1) == 0) {
                  i8 = k1 + (this.field_73842_c.nextInt(3) - 1);
               }
               ...
               int k7 = j1 - l5 * 8 - 9;
               this.func_73729_b(k7, i8, 16 + b4 * 9, 27, 9, 9);
               if(flag1) {
                  if(l5 * 2 + 1 < l) {
                     this.func_73729_b(k7, i8, j6 + 54, 27, 9, 9);
                  }

                  if(l5 * 2 + 1 == l) {
                     this.func_73729_b(k7, i8, j6 + 63, 27, 9, 9);
                  }
               }

               if(l5 * 2 + 1 < k) {
                  this.func_73729_b(k7, i8, j6 + 36, 27, 9, 9);
               }

               if(l5 * 2 + 1 == k) {
                  this.func_73729_b(k7, i8, j6 + 45, 27, 9, 9);
               }
            }
         } else if(entity instanceof EntityLivingBase) {
            this.field_73839_d.field_71424_I.func_76318_c("mountHealth");
            EntityLivingBase entitylivingbase = (EntityLivingBase)entity;
            int l7 = (int)Math.ceil((double)entitylivingbase.func_110143_aJ());
            ...
            for(int j4 = 0; l6 > 0; j4 += 20) {
               ...
               for(int l4 = 0; l4 < k4; ++l4) {
                  ...
                  int i5 = j1 - l4 * 8 - 9;
                  this.func_73729_b(i5, j7, b2 + b3 * 9, 9, 9, 9);
                  if(l4 * 2 + 1 + j4 < l7) {
                     this.func_73729_b(i5, j7, b2 + 36, 9, 9, 9);
                  }

                  if(l4 * 2 + 1 + j4 == l7) {
                     this.func_73729_b(i5, j7, b2 + 45, 9, 9, 9);
                  }
               }
         ...
         if(entityplayer.func_70055_a(Material.field_151586_h)) {
            ...
            int j8 = MathHelper.func_76143_f((double)(i6 - 2) * 10.0D / 300.0D);
            int k6 = MathHelper.func_76143_f((double)i6 * 10.0D / 300.0D) - j8;

            for(int i7 = 0; i7 < j8 + k6; ++i7) {
               if(i7 < j8) {
                  this.func_73729_b(j1 - i7 * 8 - 9, j2, 16, 18, 9, 9);
               } else {
                  this.func_73729_b(j1 - i7 * 8 - 9, j2, 25, 18, 9, 9);
               }
            }
         }
   ...
   private void func_73828_d() {
      if(BossStatus.field_82827_c != null && BossStatus.field_82826_b > 0) {
         ...
         this.func_175179_f().func_175063_a(s, (float)(i / 2 - this.func_175179_f().func_78256_a(s) / 2), (float)(b0 - 10), l);
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
         this.field_73839_d.func_110434_K().func_110577_a(field_110324_m);
      }
