...
public class BreakingFour extends BakedQuad {
   ...
   private void func_178216_a(int p_178216_1_) {
      int i = this.field_178215_a.length / 4;
      int j = i * p_178216_1_;
      float f = Float.intBitsToFloat(this.field_178215_a[j]);
      float f1 = Float.intBitsToFloat(this.field_178215_a[j + 1]);
      float f2 = Float.intBitsToFloat(this.field_178215_a[j + 2]);
      float f3 = 0.0F;
      float f4 = 0.0F;
      switch(BreakingFour.BreakingFour$1.field_178419_a[this.field_178214_c.ordinal()]) {
      case 1:
         f3 = f * 16.0F;
         f4 = (1.0F - f2) * 16.0F;
         break;
      ...
      this.field_178215_a[j + 4] = Float.floatToRawIntBits(this.field_178218_d.func_94214_a((double)f3));
      this.field_178215_a[j + 4 + 1] = Float.floatToRawIntBits(this.field_178218_d.func_94207_b((double)f4));
   }
