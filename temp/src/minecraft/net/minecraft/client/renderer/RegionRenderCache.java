...
public class RegionRenderCache extends ChunkCache {
   ...
   public TileEntity func_175625_s(BlockPos p_175625_1_) {
      ...
      if(i >= 0 && i < this.field_72817_c.length) {
         Chunk[] achunk = this.field_72817_c[i];
         if(j >= 0 && j < achunk.length) {
            Chunk chunk = achunk[j];
            return chunk == null?null:chunk.func_177424_a(p_175625_1_, Chunk.EnumCreateEntityType.QUEUED);
         } else {
            return null;
         }
      } else {
   ...
   public int func_175626_b(BlockPos p_175626_1_, int p_175626_2_) {
      ...
      if(i >= 0 && i < this.field_175634_h.length) {
   ...
   private int getCombinedLightRaw(BlockPos p_getCombinedLightRaw_1_, int p_getCombinedLightRaw_2_) {
      int i = super.func_175626_b(p_getCombinedLightRaw_1_, p_getCombinedLightRaw_2_);
      if(Config.isDynamicLights() && !this.func_180495_p(p_getCombinedLightRaw_1_).func_177230_c().func_149662_c()) {
   ...
   public IBlockState func_180495_p(BlockPos p_180495_1_) {
      ...
      if(i >= 0 && i < this.field_175635_i.length) {
         ...
         return this.func_175631_c(p_180495_1_);
      }
   }
