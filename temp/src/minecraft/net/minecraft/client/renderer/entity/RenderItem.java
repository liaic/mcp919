...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_) {
      if(p_180453_2_ != null) {
         ...
         boolean flag = p_180453_2_.func_77951_h();
         if(Reflector.ForgeItem_showDurabilityBar.exists()) {
            flag = Reflector.callBoolean(p_180453_2_.func_77973_b(), Reflector.ForgeItem_showDurabilityBar, new Object[]{p_180453_2_});
         }

         if(flag) {
            int i = (int)Math.round(13.0D - (double)p_180453_2_.func_77952_i() * 13.0D / (double)p_180453_2_.func_77958_k());
            int j = (int)Math.round(255.0D - (double)p_180453_2_.func_77952_i() * 255.0D / (double)p_180453_2_.func_77958_k());
            ...
            this.func_181565_a(worldrenderer, p_180453_3_ + 2, p_180453_4_ + 13, 12, 1, (255 - j) / 4, 64, 0, 255);
            this.func_181565_a(worldrenderer, p_180453_3_ + 2, p_180453_4_ + 13, i, 1, 255 - j, j, 0, 255);
