...
public abstract class RenderLiving extends RendererLivingEntity {
   ...
   protected boolean func_177070_b(EntityLiving p_177070_1_) {
      ...
      if(!Config.isShaders() || !Shaders.isShadowPass) {
         ...
         if(entity != null) {
            ...
            for(int i = 0; i <= 24; ++i) {
               ...
               worldrenderer.func_181662_b(p_110827_2_ + d13 * (double)f3 + 0.0D, p_110827_4_ + d14 * (double)(f3 * f3 + f3) * 0.5D + (double)((24.0F - (float)i) / 18.0F + 0.125F), p_110827_6_ + d15 * (double)f3).func_181666_a(f, f1, f2, 1.0F).func_181675_d();
               worldrenderer.func_181662_b(p_110827_2_ + d13 * (double)f3 + 0.025D, p_110827_4_ + d14 * (double)(f3 * f3 + f3) * 0.5D + (double)((24.0F - (float)i) / 18.0F + 0.125F) + 0.025D, p_110827_6_ + d15 * (double)f3).func_181666_a(f, f1, f2, 1.0F).func_181675_d();
            }
            ...
            for(int j = 0; j <= 24; ++j) {
               ...
               worldrenderer.func_181662_b(p_110827_2_ + d13 * (double)f7 + 0.0D, p_110827_4_ + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)j) / 18.0F + 0.125F) + 0.025D, p_110827_6_ + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
               worldrenderer.func_181662_b(p_110827_2_ + d13 * (double)f7 + 0.025D, p_110827_4_ + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)j) / 18.0F + 0.125F), p_110827_6_ + d15 * (double)f7 + 0.025D).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
            }
