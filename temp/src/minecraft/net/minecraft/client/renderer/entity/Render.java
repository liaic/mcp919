...
public abstract class Render {
   ...
   protected void func_147906_a(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_, double p_147906_7_, int p_147906_9_) {
      ...
      if(d0 <= (double)(p_147906_9_ * p_147906_9_)) {
         ...
         int i = fontrenderer.func_78256_a(p_147906_2_) / 2;
         GlStateManager.func_179090_x();
         worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181706_f);
         worldrenderer.func_181662_b((double)(-i - 1), (double)(-1 + b0), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
         worldrenderer.func_181662_b((double)(-i - 1), (double)(8 + b0), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
         worldrenderer.func_181662_b((double)(i + 1), (double)(8 + b0), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
         worldrenderer.func_181662_b((double)(i + 1), (double)(-1 + b0), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
         tessellator.func_78381_a();
         GlStateManager.func_179098_w();
