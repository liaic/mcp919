...
public class BlockRendererDispatcher implements IResourceManagerReloadListener {
   ...
   public void func_175020_a(IBlockState p_175020_1_, BlockPos p_175020_2_, TextureAtlasSprite p_175020_3_, IBlockAccess p_175020_4_) {
      ...
      if(i == 3) {
         ...
         if(Reflector.ISmartBlockModel.isInstance(ibakedmodel)) {
            IBlockState iblockstate = (IBlockState)Reflector.call(block, Reflector.ForgeBlock_getExtendedState, new Object[]{p_175020_1_, p_175020_4_, p_175020_2_});
            ...
            for(EnumWorldBlockLayer enumworldblocklayer : EnumWorldBlockLayer.values()) {
               if(Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, new Object[]{enumworldblocklayer})) {
                  ...
                  IBakedModel ibakedmodel3 = (new SimpleBakedModel.Builder(ibakedmodel2, p_175020_3_)).func_177645_b();
                  this.field_175027_c.func_178259_a(p_175020_4_, ibakedmodel3, p_175020_1_, p_175020_2_, Tessellator.func_178181_a().func_178180_c());
               }
            }
   ...
   public IBakedModel func_175022_a(IBlockState p_175022_1_, IBlockAccess p_175022_2_, BlockPos p_175022_3_) {
      ...
      if(Reflector.ISmartBlockModel.isInstance(ibakedmodel)) {
         IBlockState iblockstate = (IBlockState)Reflector.call(block, Reflector.ForgeBlock_getExtendedState, new Object[]{p_175022_1_, p_175022_2_, p_175022_3_});
