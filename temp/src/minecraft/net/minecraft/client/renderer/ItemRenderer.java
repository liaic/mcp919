...
public class ItemRenderer {
   ...
   public void func_78440_a(float p_78440_1_) {
      ...
      float f1 = entityplayersp.func_70678_g(p_78440_1_);
      float f2 = entityplayersp.field_70127_C + (entityplayersp.field_70125_A - entityplayersp.field_70127_C) * p_78440_1_;
      float f3 = entityplayersp.field_70126_B + (entityplayersp.field_70177_z - entityplayersp.field_70126_B) * p_78440_1_;
      this.func_178101_a(f2, f3);
      this.func_178109_a(entityplayersp);
      this.func_178110_a(entityplayersp, p_78440_1_);
      GlStateManager.func_179091_B();
      GlStateManager.func_179094_E();
      if(this.field_78453_b != null) {
         if(this.field_78453_b.func_77973_b() instanceof ItemMap) {
            this.func_178097_a(entityplayersp, f2, f, f1);
         ...
         this.func_178099_a(entityplayersp, this.field_78453_b, ItemCameraTransforms.TransformType.FIRST_PERSON);
   ...
   public void func_78447_b(float p_78447_1_) {
      ...
      if(this.field_78455_a.field_71439_g.func_70094_T()) {
         ...
         for(int i = 0; i < 8; ++i) {
            ...
            BlockPos blockpos1 = new BlockPos(d0, d1 + (double)entityplayersp.func_70047_e(), d2);
      ...
      if(this.field_78453_b != null && itemstack != null) {
         if(!this.field_78453_b.func_179549_c(itemstack)) {
            if(Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
               boolean flag1 = Reflector.callBoolean(this.field_78453_b.func_77973_b(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[]{this.field_78453_b, itemstack, Boolean.valueOf(this.field_78450_g != entityplayersp.field_71071_by.field_70461_c)});
               if(!flag1) {
