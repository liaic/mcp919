...
public class Stitcher {
   ...
   public void func_94305_f() {
      ...
      for(Stitcher.Holder stitcher$holder : astitcher$holder) {
         if(!this.func_94310_b(stitcher$holder)) {
            String s = String.format("Unable to fit: %s, size: %dx%d, atlas: %dx%d, atlasMax: %dx%d - Maybe try a lower resolution resourcepack?", new Object[]{stitcher$holder.func_98150_a().func_94215_i(), Integer.valueOf(stitcher$holder.func_98150_a().func_94211_a()), Integer.valueOf(stitcher$holder.func_98150_a().func_94216_b()), Integer.valueOf(this.field_94318_c), Integer.valueOf(this.field_94315_d), Integer.valueOf(this.field_94316_e), Integer.valueOf(this.field_94313_f)});
   ...
   public List func_94309_g() {
      ...
      for(Stitcher.Slot stitcher$slot : this.field_94317_b) {
         stitcher$slot.func_94184_a(arraylist);
      }
