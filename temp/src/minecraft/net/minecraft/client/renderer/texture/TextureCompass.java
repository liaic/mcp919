   ...
   public void func_94241_a(World p_94241_1_, double p_94241_2_, double p_94241_4_, double p_94241_6_, boolean p_94241_8_, boolean p_94241_9_) {
      if(!this.field_110976_a.isEmpty()) {
         ...
         if(i != this.field_110973_g) {
            ...
            if(Config.isShaders()) {
               ShadersTex.uploadTexSub((int[][])((int[][])this.field_110976_a.get(this.field_110973_g)), this.field_130223_c, this.field_130224_d, this.field_110975_c, this.field_110974_d, false, false);
            } else {
