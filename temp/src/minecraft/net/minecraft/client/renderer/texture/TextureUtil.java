...
public class TextureUtil {
   ...
   private static void func_147947_a(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
      ...
      for(int k = 0; k < p_147947_2_ * p_147947_3_; k += p_147947_2_ * j) {
         ...
         GL11.glTexSubImage2D(3553, p_147947_0_, p_147947_4_, p_147947_5_ + l, p_147947_2_, j, '\u80e1', '\u8367', (IntBuffer)field_111000_c);
      }
   ...
   public static void saveGlTexture(String p_saveGlTexture_0_, int p_saveGlTexture_1_, int p_saveGlTexture_2_, int p_saveGlTexture_3_, int p_saveGlTexture_4_) {
      func_94277_a(p_saveGlTexture_1_);
      ...
      for(int i = 0; i <= p_saveGlTexture_2_; ++i) {
         ...
         int[] aint = new int[l];
         GL11.glGetTexImage(3553, i, '\u80e1', '\u8367', (IntBuffer)intbuffer);
         intbuffer.get(aint);
         ...
         try {
            ...
            field_147959_c.debug("Exported png to: {}", new Object[]{file1.getAbsolutePath()});
         } catch (Exception exception) {
            field_147959_c.debug((String)"Unable to write: ", (Throwable)exception);
         }
      }
