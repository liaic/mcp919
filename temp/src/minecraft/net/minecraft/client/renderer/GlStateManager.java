...
public class GlStateManager {
   private static GlStateManager.AlphaState field_179160_a = new GlStateManager.AlphaState((GlStateManager.GlStateManager$1)null);
   ...
   private static GlStateManager.ColorMaterialState field_179156_d = new GlStateManager.ColorMaterialState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.BlendState field_179157_e = new GlStateManager.BlendState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.DepthState field_179154_f = new GlStateManager.DepthState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.FogState field_179155_g = new GlStateManager.FogState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.CullState field_179167_h = new GlStateManager.CullState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.PolygonOffsetState field_179168_i = new GlStateManager.PolygonOffsetState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.ColorLogicState field_179165_j = new GlStateManager.ColorLogicState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.TexGenState field_179166_k = new GlStateManager.TexGenState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.ClearState field_179163_l = new GlStateManager.ClearState((GlStateManager.GlStateManager$1)null);
   private static GlStateManager.StencilState field_179164_m = new GlStateManager.StencilState((GlStateManager.GlStateManager$1)null);
   ...
   private static GlStateManager.ColorMask field_179171_s = new GlStateManager.ColorMask((GlStateManager.GlStateManager$1)null);
   ...
   static {
      ...
      for(int j = 0; j < field_179174_p.length; ++j) {
         field_179174_p[j] = new GlStateManager.TextureState((GlStateManager.GlStateManager$1)null);
      }
