...
public class WorldClient extends World {
   ...
   public void func_73029_E(int p_73029_1_, int p_73029_2_, int p_73029_3_) {
      ...
      for(int i = 0; i < 1000; ++i) {
         int j = p_73029_1_ + this.field_73012_v.nextInt(b0) - this.field_73012_v.nextInt(b0);
         int k = p_73029_2_ + this.field_73012_v.nextInt(b0) - this.field_73012_v.nextInt(b0);
         int l = p_73029_3_ + this.field_73012_v.nextInt(b0) - this.field_73012_v.nextInt(b0);
         blockposm.setXyz(j, k, l);
         IBlockState iblockstate = this.func_180495_p(blockposm);
         iblockstate.func_177230_c().func_180655_c(this, blockposm, iblockstate, random);
         if(flag && iblockstate.func_177230_c() == Blocks.field_180401_cv) {
            this.func_175688_a(EnumParticleTypes.BARRIER, (double)((float)j + 0.5F), (double)((float)k + 0.5F), (double)((float)l + 0.5F), 0.0D, 0.0D, 0.0D, new int[0]);
         }
      }
