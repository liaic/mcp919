...
public class TooltipManager {
         ...
         if(System.currentTimeMillis() >= this.mouseStillTime + (long)i) {
            ...
            if(guibutton != null) {
               ...
               if(astring != null) {
                  ...
                  Gui.func_73734_a(rectangle.x, rectangle.y, rectangle.x + rectangle.width, rectangle.y + rectangle.height, -536870912);
                  ...
                  for(int l = 0; l < astring.length; ++l) {
                     ...
                     fontrenderer.func_175063_a(s, (float)(rectangle.x + 5), (float)(rectangle.y + 5 + l * 11), k);
                  }
   ...
   private void drawRectBorder(int p_drawRectBorder_1_, int p_drawRectBorder_2_, int p_drawRectBorder_3_, int p_drawRectBorder_4_, int p_drawRectBorder_5_) {
      Gui.func_73734_a(p_drawRectBorder_1_, p_drawRectBorder_2_ - 1, p_drawRectBorder_3_, p_drawRectBorder_2_, p_drawRectBorder_5_);
      Gui.func_73734_a(p_drawRectBorder_1_, p_drawRectBorder_4_, p_drawRectBorder_3_, p_drawRectBorder_4_ + 1, p_drawRectBorder_5_);
      Gui.func_73734_a(p_drawRectBorder_1_ - 1, p_drawRectBorder_2_, p_drawRectBorder_1_, p_drawRectBorder_4_, p_drawRectBorder_5_);
      Gui.func_73734_a(p_drawRectBorder_3_, p_drawRectBorder_2_, p_drawRectBorder_3_ + 1, p_drawRectBorder_4_, p_drawRectBorder_5_);
   }
}
