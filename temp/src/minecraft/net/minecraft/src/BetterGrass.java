...
public class BetterGrass {
   ...
   private static void loadProperties(TextureMap p_loadProperties_0_) {
      ...
      spriteGrass = p_loadProperties_0_.func_174942_a(new ResourceLocation("blocks/grass_top"));
      spriteGrassSide = p_loadProperties_0_.func_174942_a(new ResourceLocation("blocks/grass_side"));
      spriteMycelium = p_loadProperties_0_.func_174942_a(new ResourceLocation("blocks/mycelium_top"));
      spritePodzol = p_loadProperties_0_.func_174942_a(new ResourceLocation("blocks/dirt_podzol_top"));
      spriteSnow = p_loadProperties_0_.func_174942_a(new ResourceLocation("blocks/snow"));
      spritesLoaded = true;
   ...
   private static TextureAtlasSprite registerSprite(Properties p_registerSprite_0_, String p_registerSprite_1_, String p_registerSprite_2_, TextureMap p_registerSprite_3_) {
      ...
      TextureAtlasSprite textureatlassprite = p_registerSprite_3_.func_174942_a(resourcelocation1);
   ...
   public static List getFaceQuads(IBlockAccess p_getFaceQuads_0_, IBlockState p_getFaceQuads_1_, BlockPos p_getFaceQuads_2_, EnumFacing p_getFaceQuads_3_, List p_getFaceQuads_4_) {
      if(p_getFaceQuads_3_ != EnumFacing.UP && p_getFaceQuads_3_ != EnumFacing.DOWN) {
         if(!modelsLoaded) {
            ...
            Block block = p_getFaceQuads_1_.func_177230_c();
   ...
   private static List getFaceQuadsMycelium(IBlockAccess p_getFaceQuadsMycelium_0_, IBlockState p_getFaceQuadsMycelium_1_, BlockPos p_getFaceQuadsMycelium_2_, EnumFacing p_getFaceQuadsMycelium_3_, List p_getFaceQuadsMycelium_4_) {
      Block block = p_getFaceQuadsMycelium_0_.func_180495_p(p_getFaceQuadsMycelium_2_.func_177984_a()).func_177230_c();
      boolean flag = block == Blocks.field_150433_aE || block == Blocks.field_150431_aC;
      if(Config.isBetterGrassFancy()) {
         if(flag) {
            if(betterMyceliumSnow && getBlockAt(p_getFaceQuadsMycelium_2_, p_getFaceQuadsMycelium_3_, p_getFaceQuadsMycelium_0_) == Blocks.field_150431_aC) {
               return getQuads(modelCubeSnow, p_getFaceQuadsMycelium_3_);
            }
         } else if(betterMycelium && getBlockAt(p_getFaceQuadsMycelium_2_.func_177977_b(), p_getFaceQuadsMycelium_3_, p_getFaceQuadsMycelium_0_) == Blocks.field_150391_bh) {
   ...
   private static List getFaceQuadsDirt(IBlockAccess p_getFaceQuadsDirt_0_, IBlockState p_getFaceQuadsDirt_1_, BlockPos p_getFaceQuadsDirt_2_, EnumFacing p_getFaceQuadsDirt_3_, List p_getFaceQuadsDirt_4_) {
      ...
      if(p_getFaceQuadsDirt_1_.func_177229_b(BlockDirt.field_176386_a) != BlockDirt.DirtType.PODZOL) {
         return p_getFaceQuadsDirt_4_;
      } else {
         boolean flag = block == Blocks.field_150433_aE || block == Blocks.field_150431_aC;
         if(Config.isBetterGrassFancy()) {
            if(flag) {
               if(betterPodzolSnow && getBlockAt(p_getFaceQuadsDirt_2_, p_getFaceQuadsDirt_3_, p_getFaceQuadsDirt_0_) == Blocks.field_150431_aC) {
                  return getQuads(modelCubeSnow, p_getFaceQuadsDirt_3_);
               }
            } else if(betterPodzol) {
               BlockPos blockpos = p_getFaceQuadsDirt_2_.func_177977_b().func_177972_a(p_getFaceQuadsDirt_3_);
               IBlockState iblockstate = p_getFaceQuadsDirt_0_.func_180495_p(blockpos);
               if(iblockstate.func_177230_c() == Blocks.field_150346_d && iblockstate.func_177229_b(BlockDirt.field_176386_a) == BlockDirt.DirtType.PODZOL) {
   ...
   private static List getFaceQuadsGrass(IBlockAccess p_getFaceQuadsGrass_0_, IBlockState p_getFaceQuadsGrass_1_, BlockPos p_getFaceQuadsGrass_2_, EnumFacing p_getFaceQuadsGrass_3_, List p_getFaceQuadsGrass_4_) {
      Block block = p_getFaceQuadsGrass_0_.func_180495_p(p_getFaceQuadsGrass_2_.func_177984_a()).func_177230_c();
      boolean flag = block == Blocks.field_150433_aE || block == Blocks.field_150431_aC;
      if(Config.isBetterGrassFancy()) {
         if(flag) {
            if(betterGrassSnow && getBlockAt(p_getFaceQuadsGrass_2_, p_getFaceQuadsGrass_3_, p_getFaceQuadsGrass_0_) == Blocks.field_150431_aC) {
               return getQuads(modelCubeSnow, p_getFaceQuadsGrass_3_);
            }
         } else if(betterGrass && getBlockAt(p_getFaceQuadsGrass_2_.func_177977_b(), p_getFaceQuadsGrass_3_, p_getFaceQuadsGrass_0_) == Blocks.field_150349_c) {
   ...
   private static List getQuads(IBakedModel p_getQuads_0_, EnumFacing p_getQuads_1_) {
      return p_getQuads_1_ == null?p_getQuads_0_.func_177550_a():p_getQuads_0_.func_177551_a(p_getQuads_1_);
   }

   private static Block getBlockAt(BlockPos p_getBlockAt_0_, EnumFacing p_getBlockAt_1_, IBlockAccess p_getBlockAt_2_) {
      BlockPos blockpos = p_getBlockAt_0_.func_177972_a(p_getBlockAt_1_);
      Block block = p_getBlockAt_2_.func_180495_p(blockpos).func_177230_c();
      return block;
   }
