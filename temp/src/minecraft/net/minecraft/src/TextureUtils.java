...
public class TextureUtils {
   ...
   public static ITextureObject getTexture(ResourceLocation p_getTexture_0_) {
      ITextureObject itextureobject = Config.getTextureManager().func_110581_b(p_getTexture_0_);
      if(itextureobject != null) {
         ...
         Config.getTextureManager().func_110579_a(p_getTexture_0_, simpletexture);
   ...
   public static void registerResourceListener() {
      ...
      if(iresourcemanager instanceof IReloadableResourceManager) {
         ...
         IResourceManagerReloadListener iresourcemanagerreloadlistener = new IResourceManagerReloadListener() {
            public void func_110549_a(IResourceManager p_110549_1_) {
               TextureUtils.resourcesReloaded(p_110549_1_);
            }
         };
         ireloadableresourcemanager.func_110542_a(iresourcemanagerreloadlistener);
      }
      ...
      Config.getTextureManager().func_110580_a(resourcelocation, itickabletextureobject);
   }
   ...
   public static ResourceLocation fixResourceLocation(ResourceLocation p_fixResourceLocation_0_, String p_fixResourceLocation_1_) {
      if(!p_fixResourceLocation_0_.func_110624_b().equals("minecraft")) {
         return p_fixResourceLocation_0_;
      } else {
         String s = p_fixResourceLocation_0_.func_110623_a();
         String s1 = fixResourcePath(s, p_fixResourceLocation_1_);
         if(s1 != s) {
            p_fixResourceLocation_0_ = new ResourceLocation(p_fixResourceLocation_0_.func_110624_b(), s1);
         }
   ...
   public static void bindTexture(int p_bindTexture_0_) {
      GlStateManager.func_179144_i(p_bindTexture_0_);
   }

   public static boolean isPowerOfTwo(int p_isPowerOfTwo_0_) {
      int i = MathHelper.func_151236_b(p_isPowerOfTwo_0_);
   ...
   public static void dbgMipmaps(TextureAtlasSprite p_dbgMipmaps_0_) {
      int[][] aint = p_dbgMipmaps_0_.func_147965_a(0);
   ...
   public static void saveGlTexture(String p_saveGlTexture_0_, int p_saveGlTexture_1_, int p_saveGlTexture_2_, int p_saveGlTexture_3_, int p_saveGlTexture_4_) {
      ...
      for(int i1 = 0; i1 <= p_saveGlTexture_2_; ++i1) {
         ...
         int[] aint = new int[l];
         GL11.glGetTexImage(3553, i1, '\u80e1', '\u8367', (IntBuffer)intbuffer);
         intbuffer.get(aint);
   ...
   public static int getGLMaximumTextureSize() {
      for(int i = 65536; i > 0; i >>= 1) {
         GL11.glTexImage2D('\u8064', 0, 6408, i, i, 0, 6408, 5121, (IntBuffer)((IntBuffer)null));
         int j = GL11.glGetError();
         int k = GL11.glGetTexLevelParameteri('\u8064', 0, 4096);
         if(k != 0) {
            return i;
         }
      }
