...
import net.minecraft.src.CustomGuiProperties;
   ...
   public static ResourceLocation getTextureLocation(ResourceLocation p_getTextureLocation_0_) {
      if(guiProperties == null) {
         ...
         if(!(guiscreen instanceof GuiContainer)) {
            return p_getTextureLocation_0_;
         } else if(p_getTextureLocation_0_.func_110624_b().equals("minecraft") && p_getTextureLocation_0_.func_110623_a().startsWith("textures/gui/")) {
            if(playerControllerOF == null) {
               return p_getTextureLocation_0_;
            } else {
               IBlockAccess iblockaccess = mc.field_71441_e;
               if(iblockaccess == null) {
                  return p_getTextureLocation_0_;
               } else if(guiscreen instanceof GuiContainerCreative) {
                  return getTexturePos(CustomGuiProperties.EnumContainer.CREATIVE, mc.field_71439_g.func_180425_c(), iblockaccess, p_getTextureLocation_0_, guiscreen);
               } else if(guiscreen instanceof GuiInventory) {
                  return getTexturePos(CustomGuiProperties.EnumContainer.INVENTORY, mc.field_71439_g.func_180425_c(), iblockaccess, p_getTextureLocation_0_, guiscreen);
               } else {
   ...
   private static void update(IResourcePack p_update_0_, List<List<CustomGuiProperties>> p_update_1_) {
      ...
      for(int i = 0; i < astring.length; ++i) {
         ...
         try {
            ...
            InputStream inputstream = p_update_0_.func_110590_a(resourcelocation);
            if(inputstream == null) {
