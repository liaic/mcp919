...
public class ListQuadsOverlay {
   ...
   public IBlockState getBlockState(int p_getBlockState_1_) {
      return p_getBlockState_1_ >= 0 && p_getBlockState_1_ < this.listBlockStates.size()?(IBlockState)this.listBlockStates.get(p_getBlockState_1_):Blocks.field_150350_a.func_176223_P();
   }
