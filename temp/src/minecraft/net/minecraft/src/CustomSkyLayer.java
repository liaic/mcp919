...
import net.minecraft.src.NumUtils;
...
public class CustomSkyLayer {
      ...
      if(f3 >= 1.0E-4F) {
         ...
         if(this.rotate) {
            ...
            if(this.speed != (float)Math.round(this.speed)) {
               long i = (p_render_1_.func_72820_D() + 18000L) / 24000L;
               double d0 = (double)(this.speed % 1.0F);
               double d1 = (double)i * d0;
               f4 = (float)(d1 % 1.0D);
            }

            GlStateManager.func_179114_b(360.0F * (f4 + p_render_3_ * this.speed), this.axis[0], this.axis[1], this.axis[2]);
         }
   ...
   private float getPositionBrightnessRaw(World p_getPositionBrightnessRaw_1_) {
      ...
      if(entity == null) {
         ...
         if(this.biomes != null) {
            BiomeGenBase biomegenbase = p_getPositionBrightnessRaw_1_.func_180494_b(blockpos);
         ...
         return this.heights != null && !this.heights.isInRange(blockpos.func_177956_o())?0.0F:1.0F;
      }
   }
   ...
   private void renderSide(Tessellator p_renderSide_1_, int p_renderSide_2_) {
      WorldRenderer worldrenderer = p_renderSide_1_.func_178180_c();
   ...
   public boolean isActive(World p_isActive_1_, int p_isActive_2_) {
      ...
      if(this.timeBetween(p_isActive_2_, this.endFadeOut, this.startFadeIn)) {
         ...
         if(this.days != null) {
            long i = p_isActive_1_.func_72820_D();
