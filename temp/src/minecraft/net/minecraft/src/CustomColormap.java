...
public class CustomColormap implements CustomColors.IColorizer {
   ...
   public int getColorSmooth(IBlockAccess p_getColorSmooth_1_, double p_getColorSmooth_2_, double p_getColorSmooth_4_, double p_getColorSmooth_6_, int p_getColorSmooth_8_) {
      if(this.format == 2) {
         ...
         int i = MathHelper.func_76128_c(p_getColorSmooth_2_);
         int j = MathHelper.func_76128_c(p_getColorSmooth_4_);
         int k = MathHelper.func_76128_c(p_getColorSmooth_6_);
         int l = 0;
         int i1 = 0;
         int j1 = 0;
         int k1 = 0;
   ...
   private int getColorVanilla(BiomeGenBase p_getColorVanilla_1_, BlockPos p_getColorVanilla_2_) {
      double d0 = (double)MathHelper.func_76131_a(p_getColorVanilla_1_.func_180626_a(p_getColorVanilla_2_), 0.0F, 1.0F);
      double d1 = (double)MathHelper.func_76131_a(p_getColorVanilla_1_.func_76727_i(), 0.0F, 1.0F);
      d1 = d1 * d0;
   ...
   private int getColorGrid(BiomeGenBase p_getColorGrid_1_, BlockPos p_getColorGrid_2_) {
      int i = p_getColorGrid_1_.field_76756_M;
      int j = p_getColorGrid_2_.func_177956_o() - this.yOffset;
      if(this.yVariance > 0) {
         int k = p_getColorGrid_2_.func_177958_n() << 16 + p_getColorGrid_2_.func_177952_p();
