      ...
      if(this.lightMapRgb == null) {
         ...
         if(p_updateLightmap_4_ && i < 64) {
            ...
            if(j < 16) {
               ...
               float f = 1.1666666F * (p_updateLightmap_1_.func_72971_b(1.0F) - 0.2F);
               if(p_updateLightmap_1_.func_175658_ac() > 0) {
                  f = 1.0F;
               }
               ...
               float f3 = Config.limitTo1(Config.getGameSettings().field_74333_Y);
