      ...
      if(astring.length <= 0) {
         ...
         for(int i = 0; i < astring.length; ++i) {
            ...
            try {
               ...
               InputStream inputstream = p_getTextureAnimations_0_.func_110590_a(resourcelocation);
   ...
   public static TextureAnimation makeTextureAnimation(Properties p_makeTextureAnimation_0_, ResourceLocation p_makeTextureAnimation_1_) {
      ...
      if(s != null && s1 != null) {
         if(i >= 0 && j >= 0 && k >= 0 && l >= 0) {
            s = s.trim();
            s1 = s1.trim();
            String s2 = TextureUtils.getBasePath(p_makeTextureAnimation_1_.func_110623_a());
