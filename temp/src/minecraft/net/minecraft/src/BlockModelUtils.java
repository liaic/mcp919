...
public class BlockModelUtils {
   ...
   public static IBakedModel makeModelCube(String p_makeModelCube_0_, int p_makeModelCube_1_) {
      TextureAtlasSprite textureatlassprite = Config.getMinecraft().func_147117_R().func_110572_b(p_makeModelCube_0_);
   ...
   public static IBakedModel makeModelCube(TextureAtlasSprite p_makeModelCube_0_, int p_makeModelCube_1_) {
      ...
      IBakedModel ibakedmodel = new SimpleBakedModel(list, list1, true, true, p_makeModelCube_0_, ItemCameraTransforms.field_178357_a);
      return ibakedmodel;
   }

   public static IBakedModel joinModelsCube(IBakedModel p_joinModelsCube_0_, IBakedModel p_joinModelsCube_1_) {
      List<BakedQuad> list = new ArrayList();
      list.addAll(p_joinModelsCube_0_.func_177550_a());
      list.addAll(p_joinModelsCube_1_.func_177550_a());
      EnumFacing[] aenumfacing = EnumFacing.field_82609_l;
      ...
      for(int i = 0; i < aenumfacing.length; ++i) {
         EnumFacing enumfacing = aenumfacing[i];
         List list2 = new ArrayList();
         list2.addAll(p_joinModelsCube_0_.func_177551_a(enumfacing));
         list2.addAll(p_joinModelsCube_1_.func_177551_a(enumfacing));
         list1.add(list2);
      }

      boolean flag = p_joinModelsCube_0_.func_177555_b();
      boolean flag1 = p_joinModelsCube_0_.func_177553_d();
      TextureAtlasSprite textureatlassprite = p_joinModelsCube_0_.func_177554_e();
      ItemCameraTransforms itemcameratransforms = p_joinModelsCube_0_.func_177552_f();
   ...
   public static BakedQuad makeBakedQuad(EnumFacing p_makeBakedQuad_0_, TextureAtlasSprite p_makeBakedQuad_1_, int p_makeBakedQuad_2_) {
      ...
      BlockPartFace blockpartface = new BlockPartFace(p_makeBakedQuad_0_, p_makeBakedQuad_2_, "#" + p_makeBakedQuad_0_.func_176610_l(), blockfaceuv);
      ModelRotation modelrotation = ModelRotation.X0_Y0;
      BlockPartRotation blockpartrotation = null;
      boolean flag = false;
      boolean flag1 = true;
      FaceBakery facebakery = new FaceBakery();
      BakedQuad bakedquad = facebakery.func_178414_a(vector3f, vector3f1, blockpartface, p_makeBakedQuad_1_, p_makeBakedQuad_0_, modelrotation, blockpartrotation, flag, flag1);
      return bakedquad;
   }
      ...
      if(p_makeModel_1_ != null && p_makeModel_2_ != null) {
         ...
         if(modelmanager == null) {
            ...
            if(ibakedmodel != null && ibakedmodel != modelmanager.func_174951_a()) {
               ...
               for(int i = 0; i < aenumfacing.length; ++i) {
                  EnumFacing enumfacing = aenumfacing[i];
                  List<BakedQuad> list = ibakedmodel1.func_177551_a(enumfacing);
                  replaceTexture(list, p_makeModel_1_, p_makeModel_2_);
               }

               List<BakedQuad> list1 = ibakedmodel1.func_177550_a();
   ...
   public static AxisAlignedBB getOffsetBoundingBox(AxisAlignedBB p_getOffsetBoundingBox_0_, Block.EnumOffsetType p_getOffsetBoundingBox_1_, BlockPos p_getOffsetBoundingBox_2_) {
      int i = p_getOffsetBoundingBox_2_.func_177958_n();
      int j = p_getOffsetBoundingBox_2_.func_177952_p();
      ...
      return p_getOffsetBoundingBox_0_.func_72317_d(d0, d2, d1);
   }
}
