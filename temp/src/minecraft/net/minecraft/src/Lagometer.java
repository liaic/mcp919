...
public class Lagometer {
   ...
   public static void updateLagometer() {
      ...
      if(gameSettings.field_74330_P && (gameSettings.ofLagometer || gameSettings.field_181657_aC)) {
         active = true;
      ...
      if(gameSettings != null) {
         if(gameSettings.ofLagometer || gameSettings.field_181657_aC) {
            ...
            for(int j = 0; j < timesFrame.length; ++j) {
               ...
               k = k + 155;
               float f = (float)mc.field_71440_d;
               long l = 0L;
               if(gcs[j]) {
            ...
            renderTimeDivider(0, timesFrame.length, 33333333L, 196, 196, 196, (float)mc.field_71440_d, worldrenderer);
            renderTimeDivider(0, timesFrame.length, 16666666L, 196, 196, 196, (float)mc.field_71440_d, worldrenderer);
            tessellator.func_78381_a();
            GlStateManager.func_179098_w();
            int j2 = mc.field_71440_d - 80;
            int k2 = mc.field_71440_d - 160;
            mc.field_71466_p.func_78276_b("30", 2, k2 + 1, -8947849);
            mc.field_71466_p.func_78276_b("30", 1, k2, -3881788);
            mc.field_71466_p.func_78276_b("60", 2, j2 + 1, -8947849);
            mc.field_71466_p.func_78276_b("60", 1, j2, -3881788);
            GlStateManager.func_179128_n(5889);
            ...
            int l1 = 512 / p_showLagometer_0_.func_78325_e() + 2;
            int i2 = mc.field_71440_d / p_showLagometer_0_.func_78325_e() - 8;
            GuiIngame guiingame = mc.field_71456_v;
            GuiIngame.func_73734_a(l1 - 1, i2 - 1, l1 + 50, i2 + 10, -1605349296);
            mc.field_71466_p.func_78276_b(" " + memMbSec + " MB/s", l1, i2, k1);
   ...
   private static long renderTime(int p_renderTime_0_, long p_renderTime_1_, int p_renderTime_3_, int p_renderTime_4_, int p_renderTime_5_, float p_renderTime_6_, WorldRenderer p_renderTime_7_) {
      ...
      if(i < 3L) {
         ...
         p_renderTime_7_.func_181662_b((double)((float)p_renderTime_0_ + 0.5F), (double)(p_renderTime_6_ - (float)i + 0.5F), 0.0D).func_181669_b(p_renderTime_3_, p_renderTime_4_, p_renderTime_5_, 255).func_181675_d();
         p_renderTime_7_.func_181662_b((double)((float)p_renderTime_0_ + 0.5F), (double)(p_renderTime_6_ + 0.5F), 0.0D).func_181669_b(p_renderTime_3_, p_renderTime_4_, p_renderTime_5_, 255).func_181675_d();
         return i;
      }
   }
   ...
   private static long renderTimeDivider(int p_renderTimeDivider_0_, int p_renderTimeDivider_1_, long p_renderTimeDivider_2_, int p_renderTimeDivider_4_, int p_renderTimeDivider_5_, int p_renderTimeDivider_6_, float p_renderTimeDivider_7_, WorldRenderer p_renderTimeDivider_8_) {
      ...
      if(i < 3L) {
         ...
         p_renderTimeDivider_8_.func_181662_b((double)((float)p_renderTimeDivider_0_ + 0.5F), (double)(p_renderTimeDivider_7_ - (float)i + 0.5F), 0.0D).func_181669_b(p_renderTimeDivider_4_, p_renderTimeDivider_5_, p_renderTimeDivider_6_, 255).func_181675_d();
         p_renderTimeDivider_8_.func_181662_b((double)((float)p_renderTimeDivider_1_ + 0.5F), (double)(p_renderTimeDivider_7_ - (float)i + 0.5F), 0.0D).func_181669_b(p_renderTimeDivider_4_, p_renderTimeDivider_5_, p_renderTimeDivider_6_, 255).func_181675_d();
         return i;
      }
   }
