...
public class Lang {
   ...
   private static void loadResources(IResourcePack p_loadResources_0_, String[] p_loadResources_1_, Map p_loadResources_2_) {
      try {
         for(int i = 0; i < p_loadResources_1_.length; ++i) {
            ...
            if(p_loadResources_0_.func_110589_b(resourcelocation)) {
               InputStream inputstream = p_loadResources_0_.func_110590_a(resourcelocation);
               if(inputstream != null) {
   ...
   public static String get(String p_get_0_) {
      return I18n.func_135052_a(p_get_0_, new Object[0]);
   }

   public static String get(String p_get_0_, String p_get_1_) {
      String s = I18n.func_135052_a(p_get_0_, new Object[0]);
      return s != null && !s.equals(p_get_0_)?s:p_get_1_;
   }

   public static String getOn() {
      return I18n.func_135052_a("options.on", new Object[0]);
   }

   public static String getOff() {
      return I18n.func_135052_a("options.off", new Object[0]);
   }

   public static String getFast() {
      return I18n.func_135052_a("options.graphics.fast", new Object[0]);
   }

   public static String getFancy() {
      return I18n.func_135052_a("options.graphics.fancy", new Object[0]);
   }

   public static String getDefault() {
      return I18n.func_135052_a("generator.default", new Object[0]);
   }
}
