...
public class FontUtils {
   public static Properties readFontProperties(ResourceLocation p_readFontProperties_0_) {
      String s = p_readFontProperties_0_.func_110623_a();
      ...
      if(!s.endsWith(s1)) {
         ...
         try {
            ResourceLocation resourcelocation = new ResourceLocation(p_readFontProperties_0_.func_110624_b(), s2);
   ...
   public static ResourceLocation getHdFontLocation(ResourceLocation p_getHdFontLocation_0_) {
      if(!Config.isCustomFonts()) {
         ...
         String s = p_getHdFontLocation_0_.func_110623_a();
         String s1 = "textures/";
         String s2 = "mcpatcher/";
         if(!s.startsWith(s1)) {
            return p_getHdFontLocation_0_;
            ...
            s = s2 + s;
            ResourceLocation resourcelocation = new ResourceLocation(p_getHdFontLocation_0_.func_110624_b(), s);
