...
public class LightMapPack {
   ...
   public boolean updateLightmap(World p_updateLightmap_1_, float p_updateLightmap_2_, int[] p_updateLightmap_3_, boolean p_updateLightmap_4_, float p_updateLightmap_5_) {
      if(this.lightMapRain == null && this.lightMapThunder == null) {
         ...
         int i = p_updateLightmap_1_.field_73011_w.func_177502_q();
         if(i != 1 && i != -1) {
            float f = p_updateLightmap_1_.func_72867_j(p_updateLightmap_5_);
            float f1 = p_updateLightmap_1_.func_72819_i(p_updateLightmap_5_);
            float f2 = 1.0E-4F;
            boolean flag = f > f2;
            boolean flag1 = f1 > f2;
            if(!flag && !flag1) {
