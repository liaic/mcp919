...
public class PlayerItemParser {
   ...
   public static PlayerItemRenderer parseItemRenderer(JsonObject p_parseItemRenderer_0_, Dimension p_parseItemRenderer_1_) {
      ...
      if(!Config.equals(s, "ModelBox")) {
         ...
         modelbase.field_78090_t = p_parseItemRenderer_1_.width;
         modelbase.field_78089_u = p_parseItemRenderer_1_.height;
   ...
   public static ModelRenderer parseModelRenderer(JsonObject p_parseModelRenderer_0_, ModelBase p_parseModelRenderer_1_, int[] p_parseModelRenderer_2_, String p_parseModelRenderer_3_) {
      ...
      if(aint != null) {
         modelrenderer.func_78787_b(aint[0], aint[1]);
      }
      ...
      modelrenderer.func_78793_a(afloat[0], afloat[1], afloat[2]);
      modelrenderer.field_78795_f = afloat1[0];
      modelrenderer.field_78796_g = afloat1[1];
      modelrenderer.field_78808_h = afloat1[2];
      ...
      if(jsonarray != null) {
         for(int j = 0; j < jsonarray.size(); ++j) {
            ...
            if(aint2 != null) {
               ...
               modelrenderer.func_78784_a(aint1[0], aint1[1]);
               modelrenderer.func_78790_a(afloat2[0], afloat2[1], afloat2[2], (int)afloat2[3], (int)afloat2[4], (int)afloat2[5], f1);
            }
         }
      }
      ...
      if(jsonarray1 != null) {
         for(int k = 0; k < jsonarray1.size(); ++k) {
            ...
            modelrenderer.func_78784_a(aint3[0], aint3[1]);
