...
public class Config {
   ...
   public static boolean isCloudsFancy() {
      return gameSettings.ofClouds != 0?gameSettings.ofClouds == 2:(isShaders() && !Shaders.shaderPackClouds.isDefault()?Shaders.shaderPackClouds.isFancy():(texturePackClouds != 0?texturePackClouds == 2:gameSettings.field_74347_j));
   }
   ...
   public static void updateTexturePackClouds() {
      ...
      if(iresourcemanager != null) {
         try {
            InputStream inputstream = iresourcemanager.func_110536_a(new ResourceLocation("mcpatcher/color.properties")).func_110527_b();
            if(inputstream == null) {
               return;
            }
   ...
   public static boolean isTreesFancy() {
      return gameSettings.ofTrees == 0?gameSettings.field_74347_j:gameSettings.ofTrees != 1;
   }
   ...
   public static boolean isCullFacesLeaves() {
      return gameSettings.ofTrees == 0?!gameSettings.field_74347_j:gameSettings.ofTrees == 4;
   }
   ...
   public static InputStream getResourceStream(IResourceManager p_getResourceStream_0_, ResourceLocation p_getResourceStream_1_) throws IOException {
      IResource iresource = p_getResourceStream_0_.func_110536_a(p_getResourceStream_1_);
      return iresource == null?null:iresource.func_110527_b();
   }
   ...
   public static boolean hasResource(IResourceManager p_hasResource_0_, ResourceLocation p_hasResource_1_) {
      try {
         IResource iresource = p_hasResource_0_.func_110536_a(p_hasResource_1_);
   ...
   public static IResourcePack[] getResourcePacks() {
      ResourcePackRepository resourcepackrepository = minecraft.func_110438_M();
      ...
      if(resourcepackrepository.func_148530_e() != null) {
         list1.add(resourcepackrepository.func_148530_e());
      }
      ...
      if(minecraft.func_110438_M() == null) {
         ...
         if(airesourcepack.length <= 0) {
            ...
            for(int i = 0; i < airesourcepack.length; ++i) {
               astring[i] = airesourcepack[i].func_130077_b();
            }
      ...
      if(defaultResourcePackLazy == null) {
         ...
         if(defaultResourcePackLazy == null) {
            ...
            if(resourcepackrepository != null) {
               defaultResourcePackLazy = (DefaultResourcePack)resourcepackrepository.field_110620_b;
            }
         }
      }
   ...
   public static IResourcePack getDefiningResourcePack(ResourceLocation p_getDefiningResourcePack_0_) {
      ResourcePackRepository resourcepackrepository = minecraft.func_110438_M();
      IResourcePack iresourcepack = resourcepackrepository.func_148530_e();
      if(iresourcepack != null && iresourcepack.func_110589_b(p_getDefiningResourcePack_0_)) {
         ...
         if(list != null) {
            for(int i = list.size() - 1; i >= 0; --i) {
               ...
               IResourcePack iresourcepack1 = resourcepackrepository$entry.func_110514_c();
               if(iresourcepack1.func_110589_b(p_getDefiningResourcePack_0_)) {
                  return iresourcepack1;
               }
            }
         }

         return getDefaultResourcePack().func_110589_b(p_getDefiningResourcePack_0_)?getDefaultResourcePack():null;
      }
   }
   ...
   public static boolean isVignetteEnabled() {
      return isShaders() && !Shaders.isVignette()?false:(gameSettings.ofVignette == 0?gameSettings.field_74347_j:gameSettings.ofVignette == 2);
   }
   ...
   public static boolean isTranslucentBlocksFancy() {
      return gameSettings.ofTranslucentBlocks == 0?gameSettings.field_74347_j:gameSettings.ofTranslucentBlocks == 2;
   }
   ...
   public static int getRandom(BlockPos p_getRandom_0_, int p_getRandom_1_) {
      ...
      i = intHash(i + p_getRandom_0_.func_177958_n());
      i = intHash(i + p_getRandom_0_.func_177952_p());
      i = intHash(i + p_getRandom_0_.func_177956_o());
      return i;
   }
   ...
   public static WorldServer getWorldServer() {
      ...
      if(world == null) {
         return null;
      } else if(!minecraft.func_71387_A()) {
         return null;
      } else {
         ...
         if(integratedserver == null) {
            ...
            if(worldprovider == null) {
               ...
               int i = worldprovider.func_177502_q();

               try {
                  WorldServer worldserver = integratedserver.func_71218_a(i);
                  return worldserver;
   ...
   public static Entity getIntegratedServerEntity(UUID p_getIntegratedServerEntity_0_) {
      ...
      if(worldserver == null) {
         ...
         Entity entity = worldserver.func_175733_a(p_getIntegratedServerEntity_0_);
   ...
   public static boolean isAlternateBlocks() {
      return gameSettings.field_178880_u;
   }
   ...
   public static int getChunkViewDistance() {
      if(gameSettings == null) {
         ...
         int i = gameSettings.field_151451_c;
         return i;
      }
   }
   ...
   public static void checkDisplaySettings() {
      ...
      if(i > 0) {
         ...
         if(!Minecraft.field_142025_a && getDefaultResourcePack() != null) {
            ...
            try {
               inputstream = getDefaultResourcePack().func_152780_c(new ResourceLocation("icons/icon_16x16.png"));
               inputstream1 = getDefaultResourcePack().func_152780_c(new ResourceLocation("icons/icon_32x32.png"));
   ...
   public static void drawFps() {
      ...
      String s = getUpdates(minecraft.field_71426_K);
      int j = minecraft.field_71438_f.getCountActiveRenderers();
      int k = minecraft.field_71438_f.getCountEntitiesRendered();
      int l = minecraft.field_71438_f.getCountTileEntitiesRendered();
      String s1 = "" + i + " fps, C: " + j + ", E: " + k + "+" + l + ", U: " + s;
      minecraft.field_71466_p.func_78276_b(s1, 2, 2, -2039584);
   }
   ...
   public static void showGuiMessage(String p_showGuiMessage_0_, String p_showGuiMessage_1_) {
      GuiMessage guimessage = new GuiMessage(minecraft.field_71462_r, p_showGuiMessage_0_, p_showGuiMessage_1_);
      minecraft.func_147108_a(guimessage);
   }
