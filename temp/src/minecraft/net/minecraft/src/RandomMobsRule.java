...
public class RandomMobsRule {
               ...
               for(int i = 0; i < this.resourceLocations.length; ++i) {
                  ...
                  if(j <= 1) {
                     ...
                     if(!Config.hasResource(resourcelocation1)) {
                        Config.warn("Texture not found: " + resourcelocation1.func_110623_a());
                        return false;
                     }
   ...
   public boolean matches(EntityLiving p_matches_1_) {
      if(!Matches.biome(p_matches_1_.spawnBiome, this.biomes)) {
         ...
         return this.heights.isInRange(p_matches_1_.spawnPosition.func_177956_o());
      } else {
         if(this.nbtName != null) {
            String s = p_matches_1_.func_145818_k_()?p_matches_1_.func_95999_t():null;
