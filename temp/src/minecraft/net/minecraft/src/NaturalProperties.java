...
public class NaturalProperties {
   ...
   private BakedQuad makeQuad(BakedQuad p_makeQuad_1_, int p_makeQuad_2_, boolean p_makeQuad_3_) {
      int[] aint = p_makeQuad_1_.func_178209_a();
      int i = p_makeQuad_1_.func_178211_c();
      EnumFacing enumfacing = p_makeQuad_1_.func_178210_d();
   ...
   private boolean isFullSprite(BakedQuad p_isFullSprite_1_) {
      ...
      float f2 = f1 - f;
      float f3 = f2 / 256.0F;
      float f4 = textureatlassprite.func_94206_g();
      float f5 = textureatlassprite.func_94210_h();
      float f6 = f5 - f4;
      float f7 = f6 / 256.0F;
      int[] aint = p_isFullSprite_1_.func_178209_a();
      int i = aint.length / 4;
   ...
   private boolean equalsDelta(float p_equalsDelta_1_, float p_equalsDelta_2_, float p_equalsDelta_3_) {
      float f = MathHelper.func_76135_e(p_equalsDelta_1_ - p_equalsDelta_2_);
