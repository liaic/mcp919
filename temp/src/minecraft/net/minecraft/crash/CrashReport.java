...
public class CrashReport {
   ...
   private void func_71504_g() {
      ...
      this.field_85061_c.func_71500_a("CPU", new CrashReportCpu());
      ...
      if(Reflector.FMLCommonHandler_enhanceCrashReport.exists()) {
         ...
         Reflector.callString(object, Reflector.FMLCommonHandler_enhanceCrashReport, new Object[]{this, this.field_85061_c});
      }
   ...
   public void func_71506_a(StringBuilder p_71506_1_) {
      if((this.field_85060_g == null || this.field_85060_g.length <= 0) && this.field_71512_c.size() > 0) {
         this.field_85060_g = (StackTraceElement[])((StackTraceElement[])ArrayUtils.subarray(((CrashReportCategory)this.field_71512_c.get(0)).func_147152_a(), 0, 1));
      }
