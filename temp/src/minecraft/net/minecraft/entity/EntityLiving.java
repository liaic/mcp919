...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   protected void func_70623_bb() {
      ...
      } else if((this.field_70708_bq & 31) == 31 && (object = Reflector.call(Reflector.ForgeEventFactory_canEntityDespawn, new Object[]{this})) != object1) {
         if(object == object2) {
            this.field_70708_bq = 0;
         } else {
            this.func_70106_y();
   ...
   public void func_70625_a(Entity p_70625_1_, float p_70625_2_, float p_70625_3_) {
      ...
      if(p_70625_1_ instanceof EntityLivingBase) {
         ...
         d2 = (p_70625_1_.func_174813_aQ().field_72338_b + p_70625_1_.func_174813_aQ().field_72337_e) / 2.0D - (this.field_70163_u + (double)this.func_70047_e());
      }
   ...
   public boolean func_70094_T() {
      if(this.field_70145_X) {
         ...
         for(int i = 0; i < 8; ++i) {
            double d0 = this.field_70165_t + (double)(((float)((i >> 0) % 2) - 0.5F) * this.field_70130_N * 0.8F);
            double d1 = this.field_70163_u + (double)(((float)((i >> 1) % 2) - 0.5F) * 0.1F);
            double d2 = this.field_70161_v + (double)(((float)((i >> 2) % 2) - 0.5F) * this.field_70130_N * 0.8F);
            blockposm.setXyz(d0, d1 + (double)this.func_70047_e(), d2);
            if(this.field_70170_p.func_180495_p(blockposm).func_177230_c().func_176214_u()) {
               return true;
            }
         }
   ...
   private boolean canSkipUpdate() {
      if(this.func_70631_g_()) {
         ...
         if(world == null) {
            ...
            Entity entity = (Entity)world.field_73010_i.get(0);
