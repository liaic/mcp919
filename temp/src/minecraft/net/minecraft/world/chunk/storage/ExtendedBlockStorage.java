...
public class ExtendedBlockStorage {
   ...
   public void func_177484_a(int p_177484_1_, int p_177484_2_, int p_177484_3_, IBlockState p_177484_4_) {
      if(Reflector.IExtendedBlockState.isInstance(p_177484_4_)) {
         p_177484_4_ = (IBlockState)Reflector.call(p_177484_4_, Reflector.IExtendedBlockState_getClean, new Object[0]);
      }
   ...
   public void func_76672_e() {
      List list = Block.field_176229_d.getObjectList();
      int i = list.size();
      int j = 0;
      int k = 0;
      ...
      for(int l = 0; l < 16; ++l) {
         ...
         for(int j1 = 0; j1 < 16; ++j1) {
            ...
            for(int l1 = 0; l1 < 16; ++l1) {
               int i2 = this.field_177488_d[k1 | l1];
               if(i2 > 0) {
                  ++j;
                  if(i2 < i) {
      ...
      this.field_76682_b = j;
      this.field_76683_c = k;
   }
