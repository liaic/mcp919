...
import optifine.FieldLocatorTypes;
...
public class Reflector {
   ...
   public static boolean getFieldValueBoolean(Object obj, ReflectorField refField, boolean def) {
      try {
         ...
         if(e == null) {
            ...
            boolean value = e.getBoolean(obj);
            return value;
         }
      } catch (Throwable var5) {
   ...
   public static ReflectorField[] getReflectorFields(ReflectorClass parentClass, Class fieldType, int count) {
   ...
   public static boolean logEntry(String str) {
      Config.dbg(str);
      return true;
   }
