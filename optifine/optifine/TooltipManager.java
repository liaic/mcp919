...
import optifine.TooltipProvider;
...
public class TooltipManager {
            ...
            if(btn != null) {
               ...
               if(lines != null) {
                  ...
                  for(i = 0; i < lines.length; ++i) {
                     ...
                     fontRenderer.drawStringWithShadow(line, (float)(rect.x + 5), (float)(rect.y + 5 + i * 11), col);
                  }
   ...
   public void drawRectBorder(int x1, int y1, int x2, int y2, int col) {
