...
public class ConnectedTextures {
   ...
   public static Map[] spriteQuadMaps = null;
   ...
   public static final int Y_NEG_DOWN = 0;
   public static final int Y_POS_UP = 1;
   public static final int Z_NEG_NORTH = 2;
   public static final int Z_POS_SOUTH = 3;
   public static final int X_NEG_WEST = 4;
   public static final int X_POS_EAST = 5;
   ...
   public static BakedQuad getQuad(TextureAtlasSprite sprite, Block block, IBlockState blockState, BakedQuad quadIn) {
   ...
   public static BakedQuad makeSpriteQuad(BakedQuad quad, TextureAtlasSprite sprite) {
   ...
   public static void fixVertex(int[] data, int vertex, TextureAtlasSprite spriteFrom, TextureAtlasSprite spriteTo) {
   ...
   public static TextureAtlasSprite getConnectedTextureMultiPass(IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, EnumFacing side, TextureAtlasSprite icon, RenderEnv renderEnv) {
   ...
   public static int getSide(EnumFacing facing) {
      if(facing == null) {
         ...
         switch(ConnectedTextures.NamelessClass874533300.$SwitchMap$net$minecraft$util$EnumFacing[facing.ordinal()]) {
         case 1:
            return 0;
         case 2:
            return 1;
   ...
   public static TextureAtlasSprite getConnectedTexture(ConnectedProperties cp, IBlockAccess blockAccess, BlockStateBase blockState, BlockPos blockPos, int side, TextureAtlasSprite icon, RenderEnv renderEnv) {
      int vertAxis = 0;
      ...
      if(!cp.matchesBlock(blockState.getBlockId(), metadataCheck)) {
         ...
         if(cp.heights != null && !cp.heights.isInRange(y)) {
            ...
            case 4:
               return getConnectedTextureRandom(cp, blockAccess, blockState, blockPos, side);
            case 5:
   ...
   public static TextureAtlasSprite getConnectedTextureRandom(ConnectedProperties cp, IBlockAccess blockAccess, BlockStateBase blockState, BlockPos blockPos, int side) {
      if(cp.tileIcons.length == 1) {
         return cp.tileIcons[0];
      } else {
         int face = side / cp.symmetry * cp.symmetry;
         if(cp.linked) {
            BlockPos rand = blockPos.down();

            for(IBlockState index = blockAccess.getBlockState(rand); index.getBlock() == blockState.getBlock(); index = blockAccess.getBlockState(rand)) {
               blockPos = rand;
               rand = rand.down();
               if(rand.getY() < 0) {
                  break;
         ...
         int var11 = Config.getRandom(blockPos, face) & Integer.MAX_VALUE;
         int var12 = 0;
         if(cp.weights == null) {
            var12 = var11 % cp.tileIcons.length;
         } else {
            int randWeight = var11 % cp.sumAllWeights;
         ...
         return cp.tileIcons[var12];
      }
   }

   public static TextureAtlasSprite getConnectedTextureFixed(ConnectedProperties cp) {
      return cp.tileIcons[0];
   }

   public static TextureAtlasSprite getConnectedTextureRepeat(ConnectedProperties cp, BlockPos blockPos, int side) {
      if(cp.tileIcons.length == 1) {
         return cp.tileIcons[0];
      } else {
         int x = blockPos.getX();
   ...
   public static TextureAtlasSprite getConnectedTextureCtm(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata, RenderEnv renderEnv) {
   ...
   public static boolean isNeighbour(ConnectedProperties cp, IBlockAccess iblockaccess, IBlockState blockState, BlockPos blockPos, int side, TextureAtlasSprite icon, int metadata) {
   ...
   public static TextureAtlasSprite getNeighbourIcon(IBlockAccess iblockaccess, BlockPos blockPos, IBlockState neighbourState, int side) {
   ...
   public static TextureAtlasSprite getConnectedTextureHorizontal(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata) {
      boolean left;
      boolean right;
      left = false;
      right = false;
   ...
   public static TextureAtlasSprite getConnectedTextureVertical(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata) {
   ...
   public static TextureAtlasSprite getConnectedTextureHorizontalVertical(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata) {
   ...
   public static TextureAtlasSprite getConnectedTextureVerticalHorizontal(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata) {
      TextureAtlasSprite[] tileIcons = cp.tileIcons;
      TextureAtlasSprite iconV = getConnectedTextureVertical(cp, blockAccess, blockState, blockPos, vertAxis, side, icon, metadata);
   ...
   public static TextureAtlasSprite getConnectedTextureTop(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata) {
      boolean top = false;
      switch(vertAxis) {
      case 0:
         if(side == 1 || side == 0) {
   ...
   public static void updateIconEmpty(TextureMap textureMap) {}
   ...
   // $FF: synthetic class
   public static class NamelessClass874533300 {
