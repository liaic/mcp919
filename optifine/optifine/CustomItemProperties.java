...
public class CustomItemProperties {
   ...
   public static String parseTexture(String texStr, String texStr2, String texStr3, String path, String basePath, int type, Map<String, String> mapTexs) {
      if(texStr == null) {
         texStr = texStr2;
      }
   ...
   public ResourceLocation getTextureLocation(String texName) {
      if(texName == null) {
         return null;
      } else {
   ...
   public ResourceLocation getSpriteLocation(ResourceLocation resLoc) {
   ...
   public static IBakedModel makeBakedModel(TextureMap textureMap, ItemModelGenerator itemModelGenerator, String[] textures, boolean useTint) {
   ...
   public String getMapTexture(Map<String, String> map, String key, String def) {
      if(map == null) {
         return def;
      } else {
   ...
   public static ModelBlock makeModelBlock(String[] modelTextures) {
   ...
   public static IBakedModel bakeModel(TextureMap textureMap, ModelBlock modelBlockIn, boolean useTint) {
      ...
      Builder var5 = (new Builder(modelBlockIn)).setTexture(var4);
   ...
   public static BakedQuad makeBakedQuad(BlockPart blockPart, BlockPartFace blockPartFace, TextureAtlasSprite textureAtlasSprite, EnumFacing enumFacing, ModelRotation modelRotation, boolean uvLocked) {
