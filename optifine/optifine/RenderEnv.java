...
public class RenderEnv {
   ...
   public BlockModelRenderer.AmbientOcclusionFace aoFace;
   public BlockPosM colorizerBlockPosM;
   public boolean[] borderFlags;
   public static ThreadLocal threadLocalInstance = new ThreadLocal();


   public RenderEnv(IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos) {
   ...
   public void reset(IBlockAccess blockAccessIn, IBlockState blockStateIn, BlockPos blockPosIn) {
