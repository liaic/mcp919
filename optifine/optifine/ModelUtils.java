...
public class ModelUtils {
   ...
   public static void dbgQuads(String name, List quads, String prefix) {
   ...
   public static IBakedModel duplicateModel(IBakedModel model) {
      List generalQuads2 = duplicateQuadList(model.getGeneralQuads());
      EnumFacing[] faces = EnumFacing.VALUES;
      ...
      SimpleBakedModel var8 = new SimpleBakedModel(generalQuads2, faceQuads2, model.isAmbientOcclusion(), model.isGui3d(), model.getParticleTexture(), model.getItemCameraTransforms());
      return var8;
   }
