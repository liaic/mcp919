...
public class ConnectedProperties {
   ...
   public ConnectedProperties(Properties props, String path) {
      ...
      this.innerSeams = cp.parseBoolean(props.getProperty("innerSeams"));
      ...
      this.linked = cp.parseBoolean(props.getProperty("linked"));
   }
   ...
   public static TextureAtlasSprite[] registerIcons(String[] tileNames, TextureMap textureMap) {
      if(tileNames == null) {
         return null;
      } else {
   ...
   public int getMax(int[] mds, int max) {
      if(mds == null) {
         return max;
      } else {
