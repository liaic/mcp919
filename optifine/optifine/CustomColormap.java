...
public class CustomColormap implements CustomColors.IColorizer {
   ...
   public int color = -1;
   public int yVariance = 0;
   public int yOffset = 0;
   public int width = 0;
   public int height = 0;
   public int[] colors = null;
   public float[][] colorsRgb = (float[][])null;
   public static final int FORMAT_UNKNOWN = -1;
   public static final int FORMAT_VANILLA = 0;
   public static final int FORMAT_GRID = 1;
   public static final int FORMAT_FIXED = 2;
   ...
   public static String parseTexture(String texStr, String path, String basePath) {
      String str;
      if(texStr != null) {
         texStr = texStr.trim();
         str = ".png";
   ...
   public int getColorVanilla(BiomeGenBase biome, BlockPos blockPos) {
   ...
   public int getColorGrid(BiomeGenBase biome, BlockPos blockPos) {
   ...
   public MatchBlock getMatchBlock(int blockId) {
      if(this.matchBlocks == null) {
         return null;
      } else {
