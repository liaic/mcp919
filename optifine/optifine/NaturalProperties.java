...
public class NaturalProperties {
   ...
   public BakedQuad makeQuad(BakedQuad quad, int rotate, boolean flipU) {
   ...
   public int[] transformVertexData(int[] vertexData, int rotate, boolean flipU) {
   ...
   public boolean isFullSprite(BakedQuad quad) {
      TextureAtlasSprite sprite = quad.getSprite();
   ...
   public boolean equalsDelta(float x1, float x2, float deltaMax) {
