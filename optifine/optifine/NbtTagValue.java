...
public class NbtTagValue {
   ...
   public int valueFormat = 0;
   public static final int TYPE_TEXT = 0;
   public static final int TYPE_PATTERN = 1;
   public static final int TYPE_IPATTERN = 2;
   public static final int TYPE_REGEX = 3;
   public static final int TYPE_IREGEX = 4;
   public static final String PREFIX_PATTERN = "pattern:";
   public static final String PREFIX_IPATTERN = "ipattern:";
   public static final String PREFIX_REGEX = "regex:";
   public static final String PREFIX_IREGEX = "iregex:";
   public static final int FORMAT_DEFAULT = 0;
   public static final int FORMAT_HEX_COLOR = 1;
   public static final String PREFIX_HEX_COLOR = "#";
   public static final Pattern PATTERN_HEX_COLOR = Pattern.compile("^#[0-9a-f]{6}+$");
   ...
   public boolean matchesAnyChild(NBTBase tagBase) {
   ...
   public static NBTBase getChildTag(NBTBase tagBase, String tag) {
      if(tagBase instanceof NBTTagCompound) {
   ...
   public boolean matchesPattern(String str, String pattern) {
      return StrUtils.equalsMask(str, pattern, '*', '?');
   }

   public boolean matchesRegex(String str, String regex) {
      return str.matches(regex);
   }

   public static String getNbtString(NBTBase nbtBase, int format) {
      if(nbtBase == null) {
         return null;
         ...
         return format == 1?"#" + StrUtils.fillLeft(Integer.toHexString(d5.getInt()), 6, '0'):Integer.toString(d5.getInt());
