...
public class GuiShaders extends GuiScreen {
   ...
   public void actionPerformed(GuiButton button) {
      if(button.enabled) {
         if(button instanceof GuiButtonEnumShaderOption) {
            ...
            float var12;
            float[] var14;
            switch(GuiShaders.NamelessClass1098365822.$SwitchMap$shadersmod$client$EnumShaderOption[var11.getEnumShaderOption().ordinal()]) {
            case 1:
   ...
   // $FF: synthetic class
   public static class NamelessClass1098365822 {
