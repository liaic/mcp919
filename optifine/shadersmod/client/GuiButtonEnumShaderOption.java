...
public class GuiButtonEnumShaderOption extends GuiButton {
   ...
   public static String getButtonText(EnumShaderOption eso) {
      ...
      switch(GuiButtonEnumShaderOption.NamelessClass1453977515.$SwitchMap$shadersmod$client$EnumShaderOption[eso.ordinal()]) {
      case 1:
   ...
   // $FF: synthetic class
   public static class NamelessClass1453977515 {
