...
public class ShaderMacros {
   ...
   public static String getOs() {
      ...
      switch(ShaderMacros.NamelessClass1146160184.$SwitchMap$net$minecraft$util$Util$EnumOS[os.ordinal()]) {
      case 1:
   ...
   public static void addMacroLine(StringBuilder sb, String name, int value) {
      sb.append("#define ");
      sb.append(name);
      sb.append(" ");
      sb.append(value);
   ...
   public static void addMacroLine(StringBuilder sb, String name, float value) {
      sb.append("#define ");
      sb.append(name);
      sb.append(" ");
      sb.append(value);
   ...
   public static void addMacroLine(StringBuilder sb, String name) {
      sb.append("#define ");
      sb.append(name);
      sb.append("\n");
   }
   ...
   // $FF: synthetic class
   public static class NamelessClass1146160184 {

      // $FF: synthetic field
      public static final int[] $SwitchMap$net$minecraft$util$Util$EnumOS = new int[EnumOS.values().length];
