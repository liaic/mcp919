...
public class ShadersBuiltIn {
   ...
   public static Reader getCompositeShaderReader(boolean deferred, boolean vertex) {
   ...
   public static Reader getCompositeFragmentShaderReader(boolean deferred) {
      if(!hasDeferredPrograms() && !hasSkipClear()) {
         return null;
      } else {
         int[] flipBuffers = getLastFlipBuffers(deferred);
   ...
   public static boolean hasDeferredPrograms() {
      for(int i = 33; i < 41; ++i) {
   ...
   public static boolean hasSkipClear() {
   ...
   public static String getCompositeVertexShader(int[] buffers) {
   ...
   public static String getCompositeFragmentShader(int[] buffers) {
      ArrayList list = new ArrayList();
   ...
   public static int[] getLastFlipBuffers(boolean deferred) {
      return deferred?getLastFlipBuffers(33, 8):getLastFlipBuffers(21, 8);
   }

   public static int[] getLastFlipBuffers(int programStart, int programCount) {
      ArrayList list = new ArrayList();
   ...
   public static boolean[] getProgramTogglesTexture(int program) {
