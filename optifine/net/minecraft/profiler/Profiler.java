...
public class Profiler {
   ...
   public final List sectionList = Lists.newArrayList();
   public final List timestampList = Lists.newArrayList();
   public boolean profilingEnabled;
   public String profilingSection = "";
   public final Map profilingMap = Maps.newHashMap();
   public static final String __OBFID = "CL_00001497";
   public boolean profilerGlobalEnabled = true;
   public boolean profilerLocalEnabled;
   public static final String SCHEDULED_EXECUTABLES = "scheduledExecutables";
   public static final String TICK = "tick";
   public static final String PRE_RENDER_ERRORS = "preRenderErrors";
   public static final String RENDER = "render";
   public static final String DISPLAY = "display";
   public static final int HASH_SCHEDULED_EXECUTABLES = "scheduledExecutables".hashCode();
   public static final int HASH_TICK = "tick".hashCode();
   public static final int HASH_PRE_RENDER_ERRORS = "preRenderErrors".hashCode();
   public static final int HASH_RENDER = "render".hashCode();
   public static final int HASH_DISPLAY = "display".hashCode();
