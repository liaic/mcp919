...
public class GameRules {
   ...
   public static enum ValueType {
      ...
      public static final GameRules.ValueType[] $VALUES = new GameRules.ValueType[]{ANY_VALUE, BOOLEAN_VALUE, NUMERICAL_VALUE};
      public static final String __OBFID = "CL_00002151";
      // $FF: synthetic field
      public static final GameRules.ValueType[] $VALUES$ = new GameRules.ValueType[]{ANY_VALUE, BOOLEAN_VALUE, NUMERICAL_VALUE};


      public ValueType(String var1, int var2, String p_i45750_1_, int p_i45750_2_) {}
