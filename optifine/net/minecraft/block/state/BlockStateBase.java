...
public abstract class BlockStateBase implements IBlockState {
   ...
   public static final Function MAP_ENTRY_TO_STRING = new Function() {

      public static final String __OBFID = "CL_00002031";

      public String apply(Entry p_177225_1_) {
         if(p_177225_1_ == null) {
            return "<NULL>";
         } else {
   ...
   public static final String __OBFID = "CL_00002032";
   ...
   public static Object cyclePropertyValue(Collection values, Object currentValue) {
