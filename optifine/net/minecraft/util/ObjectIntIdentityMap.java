...
public class ObjectIntIdentityMap implements IObjectIntIterable {
   ...
   public final IdentityHashMap identityMap = new IdentityHashMap(512);
   public final List objectList = Lists.newArrayList();
   public static final String __OBFID = "CL_00001203";
