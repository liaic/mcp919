...
public class LongHashMap {
   ...
   public transient LongHashMap.Entry[] hashArray = new LongHashMap.Entry[4096];
   public transient int numHashElements;
   public int mask;
   public int capacity = 3072;
   public final float percentUseable = 0.75F;
   ...
   public static int getHashedKey(long originalKey) {
      return (int)(originalKey ^ originalKey >>> 27);
   }

   public static int hash(int integer) {
      integer ^= integer >>> 20 ^ integer >>> 12;
      return integer ^ integer >>> 7 ^ integer >>> 4;
   }

   public static int getHashIndex(int p_76158_0_, int p_76158_1_) {
   ...
   public final LongHashMap.Entry getEntry(long p_76160_1_) {
   ...
   public void resizeTable(int p_76153_1_) {
   ...
   public void copyHashTableTo(LongHashMap.Entry[] p_76154_1_) {
      LongHashMap.Entry[] var2 = this.hashArray;
   ...
   public final LongHashMap.Entry removeKey(long p_76152_1_) {
   ...
   public void createKey(int p_76156_1_, long p_76156_2_, Object p_76156_4_, int p_76156_5_) {
