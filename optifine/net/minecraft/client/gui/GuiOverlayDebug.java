...
public class GuiOverlayDebug extends Gui {
   ...
   public static final String __OBFID = "CL_00001956";
   ...
   public void renderDebugInfoRight(ScaledResolution p_175239_1_) {
   ...
   public List call() {
      ...
      if(this.isReducedDebug()) {
         return Lists.newArrayList(new String[]{"Minecraft 1.8.9 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(var1.getX() & 15), Integer.valueOf(var1.getY() & 15), Integer.valueOf(var1.getZ() & 15)})});
      } else {
   ...
   public List getDebugInfoRight() {
      ...
      long var7 = var3 - var5;
      ArrayList var9 = Lists.newArrayList(new String[]{String.format("Java: %s %dbit", new Object[]{System.getProperty("java.version"), Integer.valueOf(this.mc.isJava64bit()?64:32)}), String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{Long.valueOf(var7 * 100L / var1), Long.valueOf(bytesToMb(var7)), Long.valueOf(bytesToMb(var1))}), String.format("Allocated: % 2d%% %03dMB", new Object[]{Long.valueOf(var3 * 100L / var1), Long.valueOf(bytesToMb(var3))}), "", String.format("CPU: %s", new Object[]{OpenGlHelper.getCpu()}), "", String.format("Display: %dx%d (%s)", new Object[]{Integer.valueOf(Display.getWidth()), Integer.valueOf(Display.getHeight()), GL11.glGetString(7936)}), GL11.glGetString(7937), GL11.glGetString(7938)});
   ...
   public int getFrameColor(int p_500114_1_, int p_500114_2_, int p_500114_3_, int p_500114_4_) {
      return p_500114_1_ < p_500114_3_?this.blendColors(-16711936, -256, (float)p_500114_1_ / (float)p_500114_3_):this.blendColors(-256, -65536, (float)(p_500114_1_ - p_500114_3_) / (float)(p_500114_4_ - p_500114_3_));
   }

   public int blendColors(int p_500115_1_, int p_500115_2_, float p_500115_3_) {
      int var4 = p_500115_1_ >> 24 & 255;
      int var5 = p_500115_1_ >> 16 & 255;
      int var6 = p_500115_1_ >> 8 & 255;
      int var7 = p_500115_1_ & 255;
      int var8 = p_500115_2_ >> 24 & 255;
      int var9 = p_500115_2_ >> 16 & 255;
      int var10 = p_500115_2_ >> 8 & 255;
      int var11 = p_500115_2_ & 255;
      int var12 = MathHelper.clamp_int((int)((float)var4 + (float)(var8 - var4) * p_500115_3_), 0, 255);
      int var13 = MathHelper.clamp_int((int)((float)var5 + (float)(var9 - var5) * p_500115_3_), 0, 255);
      int var14 = MathHelper.clamp_int((int)((float)var6 + (float)(var10 - var6) * p_500115_3_), 0, 255);
      int var15 = MathHelper.clamp_int((int)((float)var7 + (float)(var11 - var7) * p_500115_3_), 0, 255);
      return var12 << 24 | var13 << 16 | var14 << 8 | var15;
   }

   public static long bytesToMb(long p_175240_0_) {
   ...
   public static final class SwitchEnumFacing {
      ...
      public static final String __OBFID = "CL_00001955";
