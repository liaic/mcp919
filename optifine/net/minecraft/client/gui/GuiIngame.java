...
public class GuiIngame extends Gui {
   ...
   public final GuiStreamIndicator streamIndicator;
   ...
   public static final String __OBFID = "CL_00000661";
   ...
   public void renderGameOverlay(float p_175180_1_) {
      ...
      if(Config.isVignetteEnabled()) {
         this.renderVignette(this.mc.thePlayer.getBrightness(p_175180_1_), var2);
      } else {
      ...
      if(this.mc.playerController.isSpectator()) {
         this.spectatorGui.renderTooltip(var2, p_175180_1_);
      } else {
         this.renderTooltip(var2, p_175180_1_);
      }
      ...
      if(this.titlesTimer > 0) {
         ...
         var7 = (float)this.titlesTimer - p_175180_1_;
         var8 = 255;
         if(this.titlesTimer > this.titleFadeOut + this.titleDisplayTime) {
            float var12 = (float)(this.titleFadeIn + this.titleDisplayTime + this.titleFadeOut) - var7;
            var8 = (int)(var12 * 255.0F / (float)this.titleFadeIn);
         }
   ...
   public void renderTooltip(ScaledResolution p_180479_1_, float p_180479_2_) {
      if(this.mc.getRenderViewEntity() instanceof EntityPlayer) {
         ...
         for(int var6 = 0; var6 < 9; ++var6) {
            ...
            this.renderHotbarItem(var6, var7, var8, p_180479_2_, var3);
         }
   ...
   public void renderSelectedItem(ScaledResolution p_175182_1_) {
   ...
   public void renderPumpkinOverlay(ScaledResolution p_180476_1_) {
      ...
      var3.pos(0.0D, (double)p_180476_1_.getScaledHeight(), -90.0D).tex(0.0D, 1.0D).endVertex();
      var3.pos((double)p_180476_1_.getScaledWidth(), (double)p_180476_1_.getScaledHeight(), -90.0D).tex(1.0D, 1.0D).endVertex();
      var3.pos((double)p_180476_1_.getScaledWidth(), 0.0D, -90.0D).tex(1.0D, 0.0D).endVertex();
   ...
   public void renderVignette(float p_180480_1_, ScaledResolution p_180480_2_) {
      if(!Config.isVignetteEnabled()) {
         ...
         var10.pos(0.0D, (double)p_180480_2_.getScaledHeight(), -90.0D).tex(0.0D, 1.0D).endVertex();
         var10.pos((double)p_180480_2_.getScaledWidth(), (double)p_180480_2_.getScaledHeight(), -90.0D).tex(1.0D, 1.0D).endVertex();
         var10.pos((double)p_180480_2_.getScaledWidth(), 0.0D, -90.0D).tex(1.0D, 0.0D).endVertex();
   ...
   public void renderPortal(float p_180474_1_, ScaledResolution p_180474_2_) {
      if(p_180474_1_ < 1.0F) {
      ...
      var9.pos(0.0D, (double)p_180474_2_.getScaledHeight(), -90.0D).tex((double)var4, (double)var7).endVertex();
      var9.pos((double)p_180474_2_.getScaledWidth(), (double)p_180474_2_.getScaledHeight(), -90.0D).tex((double)var6, (double)var7).endVertex();
      var9.pos((double)p_180474_2_.getScaledWidth(), 0.0D, -90.0D).tex((double)var6, (double)var5).endVertex();
   ...
   public void renderHotbarItem(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_) {
