...
public abstract class Render {
   ...
   public static final String __OBFID = "CL_00000992";


   public Render(RenderManager p_i46179_1_) {
   ...
   public boolean shouldRender(Entity p_177071_1_, ICamera p_177071_2_, double p_177071_3_, double p_177071_5_, double p_177071_7_) {
      AxisAlignedBB var9 = p_177071_1_.getEntityBoundingBox();
      if(var9.hasNaN() || var9.getAverageEdgeLength() == 0.0D) {
         var9 = new AxisAlignedBB(p_177071_1_.posX - 2.0D, p_177071_1_.posY - 2.0D, p_177071_1_.posZ - 2.0D, p_177071_1_.posX + 2.0D, p_177071_1_.posY + 2.0D, p_177071_1_.posZ + 2.0D);
      }

      return p_177071_1_.isInRangeToRender3d(p_177071_3_, p_177071_5_, p_177071_7_) && (p_177071_1_.ignoreFrustumCheck || p_177071_2_.isBoundingBoxInFrustum(var9));
   }
   ...
   public void renderOffsetLivingLabel(Entity p_177069_1_, double p_177069_2_, double p_177069_4_, double p_177069_6_, String p_177069_8_, float p_177069_9_, double p_177069_10_) {
   ...
   public boolean bindEntityTexture(Entity p_180548_1_) {
   ...
   public void renderEntityOnFire(Entity p_76977_1_, double p_76977_2_, double p_76977_4_, double p_76977_6_, float p_76977_8_) {
   ...
   public void renderShadow(Entity p_76975_1_, double p_76975_2_, double p_76975_4_, double p_76975_6_, float p_76975_8_, float p_76975_9_) {
      if(!Config.isShaders() || !Shaders.shouldSkipDefaultShadow) {
         ...
         Iterator var32 = BlockPos.getAllInBoxMutable(new BlockPos(var18, var20, var22), new BlockPos(var19, var21, var23)).iterator();
         ...
         while(var32.hasNext()) {
            ...
            if(var34.getRenderType() != -1 && var10.getLightFromNeighbors(var33) > 3) {
               this.renderShadowBlock(var34, p_76975_2_, p_76975_4_, p_76975_6_, var33, p_76975_8_, var11, var24, var26, var28);
            }
         }
   ...
   public void renderShadowBlock(Block p_180549_1_, double p_180549_2_, double p_180549_4_, double p_180549_6_, BlockPos p_180549_8_, float p_180549_9_, float p_180549_10_, double p_180549_11_, double p_180549_13_, double p_180549_15_) {
   ...
   public static void renderOffsetAABB(AxisAlignedBB p_76978_0_, double p_76978_1_, double p_76978_3_, double p_76978_5_) {
      ...
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.minZ).normal(0.0F, 0.0F, -1.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.minZ).normal(0.0F, 0.0F, -1.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.minZ).normal(0.0F, 0.0F, -1.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.minZ).normal(0.0F, 0.0F, -1.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.maxZ).normal(0.0F, 0.0F, 1.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.maxZ).normal(0.0F, 0.0F, 1.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(0.0F, 0.0F, 1.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(0.0F, 0.0F, 1.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.minZ).normal(0.0F, -1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.minZ).normal(0.0F, -1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.maxZ).normal(0.0F, -1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.maxZ).normal(0.0F, -1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(0.0F, 1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(0.0F, 1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.minZ).normal(0.0F, 1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.minZ).normal(0.0F, 1.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.maxZ).normal(-1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(-1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.maxY, p_76978_0_.minZ).normal(-1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.minX, p_76978_0_.minY, p_76978_0_.minZ).normal(-1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.minZ).normal(1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.minZ).normal(1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.maxY, p_76978_0_.maxZ).normal(1.0F, 0.0F, 0.0F).endVertex();
      var8.pos(p_76978_0_.maxX, p_76978_0_.minY, p_76978_0_.maxZ).normal(1.0F, 0.0F, 0.0F).endVertex();
      var7.draw();
