...
public class RenderManager {
   ...
   public Render getEntityRenderObject(Entity p_78713_1_) {
      if(p_78713_1_ instanceof AbstractClientPlayer) {
         String var2 = ((AbstractClientPlayer)p_78713_1_).getSkinType();
   ...
   public boolean shouldRender(Entity p_178635_1_, ICamera p_178635_2_, double p_178635_3_, double p_178635_5_, double p_178635_7_) {
      ...
      return var9 != null && var9.shouldRender(p_178635_1_, p_178635_2_, p_178635_3_, p_178635_5_, p_178635_7_);
   }
   ...
   public void renderWitherSkull(Entity p_178630_1_, float p_178630_2_) {
      ...
      if(var9 != null && this.renderEngine != null) {
         ...
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         var9.renderName(p_178630_1_, var3 - this.renderPosX, var5 - this.renderPosY, var7 - this.renderPosZ);
      }
   ...
   public void renderDebugBoundingBox(Entity p_85094_1_, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_) {
      ...
      if(p_85094_1_ instanceof EntityLivingBase) {
         float var16 = 0.01F;
         RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(p_85094_2_ - (double)var10, p_85094_4_ + (double)p_85094_1_.getEyeHeight() - 0.009999999776482582D, p_85094_6_ - (double)var10, p_85094_2_ + (double)var10, p_85094_4_ + (double)p_85094_1_.getEyeHeight() + 0.009999999776482582D, p_85094_6_ + (double)var10), 255, 0, 0, 255);
      }
      ...
      var14.pos(p_85094_2_, p_85094_4_ + (double)p_85094_1_.getEyeHeight(), p_85094_6_).color(0, 0, 255, 255).endVertex();
      var14.pos(p_85094_2_ + var15.xCoord * 2.0D, p_85094_4_ + (double)p_85094_1_.getEyeHeight() + var15.yCoord * 2.0D, p_85094_6_ + var15.zCoord * 2.0D).color(0, 0, 255, 255).endVertex();
      var161.draw();
