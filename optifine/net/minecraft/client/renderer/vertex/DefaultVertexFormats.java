...
public class DefaultVertexFormats {
   ...
   public static final VertexFormat BLOCK_VANILLA = BLOCK;
   public static final VertexFormat ITEM_VANILLA = ITEM;
   ...
   public static final String __OBFID = "CL_00002403";
   ...
   public static void updateVertexFormats() {
      ...
      if(Reflector.Attributes_DEFAULT_BAKED_FORMAT.exists()) {
         ...
         for(int i = 0; i < vfSrc.getElementCount(); ++i) {
            vfDst.addElement(vfSrc.getElement(i));
         }
      }
