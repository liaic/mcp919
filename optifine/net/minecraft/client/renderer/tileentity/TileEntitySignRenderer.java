...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer {
   ...
   public final ModelSign model = new ModelSign();
   public static final String __OBFID = "CL_00000970";


   public void renderTileEntityAt(TileEntitySign p_180541_1_, double p_180541_2_, double p_180541_4_, double p_180541_6_, float p_180541_8_, int p_180541_9_) {
      ...
      if(p_180541_9_ < 0) {
         for(int var15 = 0; var15 < p_180541_1_.signText.length; ++var15) {
            if(p_180541_1_.signText[var15] != null) {
               ...
               List var17 = GuiUtilRenderComponents.splitText(var16, 90, var201, false, true);
   ...
   public void renderTileEntityAt(TileEntity p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      this.renderTileEntityAt((TileEntitySign)p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_, p_180535_9_);
   }
