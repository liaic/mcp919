...
public class VisGraph {
   ...
   public static final int field_178616_a = (int)Math.pow(16.0D, 0.0D);
   public static final int field_178614_b = (int)Math.pow(16.0D, 1.0D);
   public static final int field_178615_c = (int)Math.pow(16.0D, 2.0D);
   public final BitSet field_178612_d = new BitSet(4096);
   public static final int[] field_178613_e = new int[1352];
   public int field_178611_f = 4096;
   public static final String __OBFID = "CL_00002450";
   ...
   public static int getIndex(BlockPos p_178608_0_) {
      return getIndex(p_178608_0_.getX() & 15, p_178608_0_.getY() & 15, p_178608_0_.getZ() & 15);
   }

   public static int getIndex(int p_178605_0_, int p_178605_1_, int p_178605_2_) {
   ...
   public Set func_178609_b(BlockPos p_178609_1_) {
      return this.func_178604_a(getIndex(p_178609_1_));
   }

   public Set func_178604_a(int p_178604_1_) {
   ...
   public void func_178610_a(int p_178610_1_, Set p_178610_2_) {
   ...
   public int func_178603_a(int p_178603_1_, EnumFacing p_178603_2_) {
   ...
   public static final class SwitchEnumFacing {
      ...
      public static final int[] field_178617_a = new int[EnumFacing.values().length];
      public static final String __OBFID = "CL_00002449";
