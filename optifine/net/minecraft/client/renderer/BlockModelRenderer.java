...
public class BlockModelRenderer {
   ...
   public static final String __OBFID = "CL_00002518";
         ...
         if(!stateSnow.isEmpty()) {
            ...
            if(!checkSides || blockIn.shouldSideBeRendered(blockAccessIn, var16, modelSnow)) {
               ...
               if(!renderEnv.isBreakingAnimation(stateSnow) && Config.isBetterGrass()) {
                  stateSnow = BetterGrass.getFaceQuads(blockAccessIn, blockStateIn, blockPosIn, modelSnow, stateSnow);
               }
   ...
   public void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
      ...
      EnumOffsetType var15 = blockIn.getOffsetType();
   ...
   public void fillQuadBounds(Block blockIn, int[] vertexData, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags) {
      float var6 = 32.0F;
      float var7 = 32.0F;
      float var8 = 32.0F;
      float var9 = -32.0F;
   ...
   public void renderModelStandardQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing faceIn, int brightnessIn, boolean ownBrightness, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
      BitSet boundsFlags = renderEnv.getBoundsFlags();
      IBlockState blockStateIn = renderEnv.getBlockState();
      double var10 = (double)blockPosIn.getX();
      double var12 = (double)blockPosIn.getY();
      double var14 = (double)blockPosIn.getZ();
      EnumOffsetType var16 = blockIn.getOffsetType();
      if(var16 != EnumOffsetType.NONE) {
         int var23 = blockPosIn.getX();
         int var24 = blockPosIn.getZ();
         long var19 = (long)(var23 * 3129871) ^ (long)var24 * 116129781L;
      ...
      for(Iterator var231 = listQuadsIn.iterator(); var231.hasNext(); worldRendererIn.putPosition(var10, var12, var14)) {
         ...
         int colorMultiplier1 = CustomColors.getColorMultiplier(var241, blockIn, blockAccessIn, blockPosIn, renderEnv);
         if(var241.hasTintIndex() || colorMultiplier1 != -1) {
            int var25;
            if(colorMultiplier1 != -1) {
   ...
   public void renderModelBrightnessColor(IBakedModel p_178262_1_, float p_178262_2_, float p_178262_3_, float p_178262_4_, float p_178262_5_) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         this.renderModelBrightnessColorQuads(p_178262_2_, p_178262_3_, p_178262_4_, p_178262_5_, p_178262_1_.getFaceQuads(var9));
      }
   ...
   public void renderModelBrightnessColorQuads(float p_178264_1_, float p_178264_2_, float p_178264_3_, float p_178264_4_, List p_178264_5_) {
   ...
   public static final class SwitchEnumFacing {
      ...
      public static final int[] field_178290_a = new int[EnumFacing.values().length];
      public static final String __OBFID = "CL_00002517";
   ...
   public static class AmbientOcclusionFace {
      ...
      public static final String __OBFID = "CL_00002515";
   ...
   public static enum EnumNeighborInfo {
      ...
      public final EnumFacing[] field_178276_g;
      public final float field_178288_h;
      public final boolean field_178289_i;
      public final BlockModelRenderer.Orientation[] field_178286_j;
      public final BlockModelRenderer.Orientation[] field_178287_k;
      public final BlockModelRenderer.Orientation[] field_178284_l;
      public final BlockModelRenderer.Orientation[] field_178285_m;
      public static final BlockModelRenderer.EnumNeighborInfo[] VALUES = new BlockModelRenderer.EnumNeighborInfo[6];
      public static final BlockModelRenderer.EnumNeighborInfo[] $VALUES = new BlockModelRenderer.EnumNeighborInfo[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};
      public static final String __OBFID = "CL_00002516";
      // $FF: synthetic field
      public static final BlockModelRenderer.EnumNeighborInfo[] $VALUES$ = new BlockModelRenderer.EnumNeighborInfo[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};


      public EnumNeighborInfo(String var1, int var2, String p_i46236_1_, int p_i46236_2_, EnumFacing[] p_i46236_3_, float p_i46236_4_, boolean p_i46236_5_, BlockModelRenderer.Orientation[] p_i46236_6_, BlockModelRenderer.Orientation[] p_i46236_7_, BlockModelRenderer.Orientation[] p_i46236_8_, BlockModelRenderer.Orientation[] p_i46236_9_) {
   ...
   public static enum Orientation {
      ...
      public static final BlockModelRenderer.Orientation[] $VALUES = new BlockModelRenderer.Orientation[]{DOWN, UP, NORTH, SOUTH, WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST};
      public static final String __OBFID = "CL_00002513";
      // $FF: synthetic field
      public static final BlockModelRenderer.Orientation[] $VALUES$ = new BlockModelRenderer.Orientation[]{DOWN, UP, NORTH, SOUTH, WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST};


      public Orientation(String var1, int var2, String p_i46233_1_, int p_i46233_2_, EnumFacing p_i46233_3_, boolean p_i46233_4_) {
   ...
   public static enum VertexTranslations {
      ...
      public static final BlockModelRenderer.VertexTranslations[] VALUES = new BlockModelRenderer.VertexTranslations[6];
      public static final BlockModelRenderer.VertexTranslations[] $VALUES = new BlockModelRenderer.VertexTranslations[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};
      public static final String __OBFID = "CL_00002514";
      // $FF: synthetic field
      public static final BlockModelRenderer.VertexTranslations[] $VALUES$ = new BlockModelRenderer.VertexTranslations[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};


      public VertexTranslations(String var1, int var2, String p_i46234_1_, int p_i46234_2_, int p_i46234_3_, int p_i46234_4_, int p_i46234_5_, int p_i46234_6_) {
