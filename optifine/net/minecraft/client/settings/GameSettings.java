...
public class GameSettings {
   ...
   public static final String[] CLOUDS_TYPES = new String[]{"options.off", "options.graphics.fast", "options.graphics.fancy"};
   ...
   public final Set setModelParts;
   ...
   public static final int[] OF_TREES_VALUES = new int[]{0, 1, 4, 2};
         ...
         while((var2 = var9.readLine()) != null) {
            try {
               ...
               if(var8[0].equals("incompatibleResourcePacks")) {
                  this.incompatibleResourcePacks = (List)gson.fromJson(var2.substring(var2.indexOf(58) + 1), typeListString);
               ...
               if(var8[0].equals("useNativeTransport")) {
                  this.useNativeTransport = var8[1].equals("true");
               }

               if(var8[0].equals("entityShadows")) {
                  this.entityShadows = var8[1].equals("true");
               }
   ...
   public void saveOptions() {
      ...
      try {
         ...
         switch(this.clouds) {
         case 0:
            var9.println("renderClouds:false");
            break;
         case 1:
            var9.println("renderClouds:fast");
            break;
         case 2:
            var9.println("renderClouds:true");
         }
         ...
         var9.println("useNativeTransport:" + this.useNativeTransport);
         var9.println("entityShadows:" + this.entityShadows);
   ...
   public void setOptionFloatValueOF(GameSettings.Options option, float val) {
   ...
   public void setOptionValueOF(GameSettings.Options par1EnumOptions, int par2) {
   ...
   public String getKeyBindingOF(GameSettings.Options par1EnumOptions) {
   ...
   public void loadOfOptions() {
      try {
         ...
         BufferedReader bufferedreader = new BufferedReader(new InputStreamReader(new FileInputStream(exception), "UTF-8"));
         String s = "";
         ...
         while((s = bufferedreader.readLine()) != null) {
            try {
               ...
               if(exception1[0].equals("ofCustomGuis") && exception1.length >= 2) {
                  this.ofCustomGuis = Boolean.valueOf(exception1[1]).booleanValue();
               }
   ...
   public void saveOfOptions() {
      try {
         PrintWriter exception = new PrintWriter(new OutputStreamWriter(new FileOutputStream(this.optionsFileOF), "UTF-8"));
         ...
         exception.println("ofCustomGuis:" + this.ofCustomGuis);
   ...
   public static final class SwitchOptions {
      ...
      public static final int[] field_151477_a = new int[GameSettings.Options.values().length];
   ...
   public static enum Options {
      ...
      REALMS_NOTIFICATIONS("REALMS_NOTIFICATIONS", 44, "REALMS_NOTIFICATIONS", 44, "options.realmsNotifications", false, true),
      FOG_FANCY("FOG_FANCY", 45, "", 999, "of.options.FOG_FANCY", false, false),
      FOG_START("FOG_START", 46, "", 999, "of.options.FOG_START", false, false),
      MIPMAP_TYPE("MIPMAP_TYPE", 47, "", 999, "of.options.MIPMAP_TYPE", true, false, 0.0F, 3.0F, 1.0F),
      SMOOTH_FPS("SMOOTH_FPS", 48, "", 999, "of.options.SMOOTH_FPS", false, false),
      CLOUDS("CLOUDS", 49, "", 999, "of.options.CLOUDS", false, false),
      CLOUD_HEIGHT("CLOUD_HEIGHT", 50, "", 999, "of.options.CLOUD_HEIGHT", true, false),
      TREES("TREES", 51, "", 999, "of.options.TREES", false, false),
      RAIN("RAIN", 52, "", 999, "of.options.RAIN", false, false),
      ANIMATED_WATER("ANIMATED_WATER", 53, "", 999, "of.options.ANIMATED_WATER", false, false),
      ANIMATED_LAVA("ANIMATED_LAVA", 54, "", 999, "of.options.ANIMATED_LAVA", false, false),
      ANIMATED_FIRE("ANIMATED_FIRE", 55, "", 999, "of.options.ANIMATED_FIRE", false, false),
      ANIMATED_PORTAL("ANIMATED_PORTAL", 56, "", 999, "of.options.ANIMATED_PORTAL", false, false),
      AO_LEVEL("AO_LEVEL", 57, "", 999, "of.options.AO_LEVEL", true, false),
      LAGOMETER("LAGOMETER", 58, "", 999, "of.options.LAGOMETER", false, false),
      SHOW_FPS("SHOW_FPS", 59, "", 999, "of.options.SHOW_FPS", false, false),
      AUTOSAVE_TICKS("AUTOSAVE_TICKS", 60, "", 999, "of.options.AUTOSAVE_TICKS", false, false),
      BETTER_GRASS("BETTER_GRASS", 61, "", 999, "of.options.BETTER_GRASS", false, false),
      ANIMATED_REDSTONE("ANIMATED_REDSTONE", 62, "", 999, "of.options.ANIMATED_REDSTONE", false, false),
      ANIMATED_EXPLOSION("ANIMATED_EXPLOSION", 63, "", 999, "of.options.ANIMATED_EXPLOSION", false, false),
      ANIMATED_FLAME("ANIMATED_FLAME", 64, "", 999, "of.options.ANIMATED_FLAME", false, false),
      ANIMATED_SMOKE("ANIMATED_SMOKE", 65, "", 999, "of.options.ANIMATED_SMOKE", false, false),
      WEATHER("WEATHER", 66, "", 999, "of.options.WEATHER", false, false),
      SKY("SKY", 67, "", 999, "of.options.SKY", false, false),
      STARS("STARS", 68, "", 999, "of.options.STARS", false, false),
      SUN_MOON("SUN_MOON", 69, "", 999, "of.options.SUN_MOON", false, false),
      VIGNETTE("VIGNETTE", 70, "", 999, "of.options.VIGNETTE", false, false),
      CHUNK_UPDATES("CHUNK_UPDATES", 71, "", 999, "of.options.CHUNK_UPDATES", false, false),
      CHUNK_UPDATES_DYNAMIC("CHUNK_UPDATES_DYNAMIC", 72, "", 999, "of.options.CHUNK_UPDATES_DYNAMIC", false, false),
      TIME("TIME", 73, "", 999, "of.options.TIME", false, false),
      CLEAR_WATER("CLEAR_WATER", 74, "", 999, "of.options.CLEAR_WATER", false, false),
      SMOOTH_WORLD("SMOOTH_WORLD", 75, "", 999, "of.options.SMOOTH_WORLD", false, false),
      VOID_PARTICLES("VOID_PARTICLES", 76, "", 999, "of.options.VOID_PARTICLES", false, false),
      WATER_PARTICLES("WATER_PARTICLES", 77, "", 999, "of.options.WATER_PARTICLES", false, false),
      RAIN_SPLASH("RAIN_SPLASH", 78, "", 999, "of.options.RAIN_SPLASH", false, false),
      PORTAL_PARTICLES("PORTAL_PARTICLES", 79, "", 999, "of.options.PORTAL_PARTICLES", false, false),
      POTION_PARTICLES("POTION_PARTICLES", 80, "", 999, "of.options.POTION_PARTICLES", false, false),
      FIREWORK_PARTICLES("FIREWORK_PARTICLES", 81, "", 999, "of.options.FIREWORK_PARTICLES", false, false),
      PROFILER("PROFILER", 82, "", 999, "of.options.PROFILER", false, false),
      DRIPPING_WATER_LAVA("DRIPPING_WATER_LAVA", 83, "", 999, "of.options.DRIPPING_WATER_LAVA", false, false),
      BETTER_SNOW("BETTER_SNOW", 84, "", 999, "of.options.BETTER_SNOW", false, false),
      FULLSCREEN_MODE("FULLSCREEN_MODE", 85, "", 999, "of.options.FULLSCREEN_MODE", false, false),
      ANIMATED_TERRAIN("ANIMATED_TERRAIN", 86, "", 999, "of.options.ANIMATED_TERRAIN", false, false),
      SWAMP_COLORS("SWAMP_COLORS", 87, "", 999, "of.options.SWAMP_COLORS", false, false),
      RANDOM_MOBS("RANDOM_MOBS", 88, "", 999, "of.options.RANDOM_MOBS", false, false),
      SMOOTH_BIOMES("SMOOTH_BIOMES", 89, "", 999, "of.options.SMOOTH_BIOMES", false, false),
      CUSTOM_FONTS("CUSTOM_FONTS", 90, "", 999, "of.options.CUSTOM_FONTS", false, false),
      CUSTOM_COLORS("CUSTOM_COLORS", 91, "", 999, "of.options.CUSTOM_COLORS", false, false),
      SHOW_CAPES("SHOW_CAPES", 92, "", 999, "of.options.SHOW_CAPES", false, false),
      CONNECTED_TEXTURES("CONNECTED_TEXTURES", 93, "", 999, "of.options.CONNECTED_TEXTURES", false, false),
      CUSTOM_ITEMS("CUSTOM_ITEMS", 94, "", 999, "of.options.CUSTOM_ITEMS", false, false),
      AA_LEVEL("AA_LEVEL", 95, "", 999, "of.options.AA_LEVEL", true, false, 0.0F, 16.0F, 1.0F),
      AF_LEVEL("AF_LEVEL", 96, "", 999, "of.options.AF_LEVEL", true, false, 1.0F, 16.0F, 1.0F),
      ANIMATED_TEXTURES("ANIMATED_TEXTURES", 97, "", 999, "of.options.ANIMATED_TEXTURES", false, false),
      NATURAL_TEXTURES("NATURAL_TEXTURES", 98, "", 999, "of.options.NATURAL_TEXTURES", false, false),
      HELD_ITEM_TOOLTIPS("HELD_ITEM_TOOLTIPS", 99, "", 999, "of.options.HELD_ITEM_TOOLTIPS", false, false),
      DROPPED_ITEMS("DROPPED_ITEMS", 100, "", 999, "of.options.DROPPED_ITEMS", false, false),
      LAZY_CHUNK_LOADING("LAZY_CHUNK_LOADING", 101, "", 999, "of.options.LAZY_CHUNK_LOADING", false, false),
      CUSTOM_SKY("CUSTOM_SKY", 102, "", 999, "of.options.CUSTOM_SKY", false, false),
      FAST_MATH("FAST_MATH", 103, "", 999, "of.options.FAST_MATH", false, false),
      FAST_RENDER("FAST_RENDER", 104, "", 999, "of.options.FAST_RENDER", false, false),
      TRANSLUCENT_BLOCKS("TRANSLUCENT_BLOCKS", 105, "", 999, "of.options.TRANSLUCENT_BLOCKS", false, false),
      DYNAMIC_FOV("DYNAMIC_FOV", 106, "", 999, "of.options.DYNAMIC_FOV", false, false),
      DYNAMIC_LIGHTS("DYNAMIC_LIGHTS", 107, "", 999, "of.options.DYNAMIC_LIGHTS", false, false),
      CUSTOM_GUIS("CUSTOM_GUIS", 108, "", 999, "of.options.CUSTOM_GUIS", false, false);
      ...
      public Options(String var1, int var2, String p_i1015_1_, int p_i1015_2_, String p_i1015_3_, boolean p_i1015_4_, boolean p_i1015_5_) {
         this(var1, var2, p_i1015_1_, p_i1015_2_, p_i1015_3_, p_i1015_4_, p_i1015_5_, 0.0F, 1.0F, 0.0F);
      }

      public Options(String var1, int var2, String p_i45004_1_, int p_i45004_2_, String p_i45004_3_, boolean p_i45004_4_, boolean p_i45004_5_, float p_i45004_6_, float p_i45004_7_, float p_i45004_8_) {
