...
public abstract class AbstractResourcePack implements IResourcePack {
   ...
   public static final Logger resourceLog = LogManager.getLogger();
   public final File resourcePackFile;
   public static final String __OBFID = "CL_00001072";
   ...
   public static String locationToName(ResourceLocation p_110592_0_) {
      return String.format("%s/%s/%s", new Object[]{"assets", p_110592_0_.getResourceDomain(), p_110592_0_.getResourcePath()});
   }

   public static String getRelativeName(File p_110595_0_, File p_110595_1_) {
   ...
   public abstract InputStream getInputStreamByName(String var1) throws IOException;

   public abstract boolean hasResourceName(String var1);

   public void logNameNotLowercase(String p_110594_1_) {
