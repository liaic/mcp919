...
public class PotionHelper {
   ...
   public static final Map DATAVALUE_COLORS;
   public static final String[] potionPrefixes;
   public static final String __OBFID = "CL_00000078";
   ...
   public static int isFlagSet(int p_77910_0_, int p_77910_1_) {
      return checkFlag(p_77910_0_, p_77910_1_)?1:0;
   }

   public static int isFlagUnset(int p_77916_0_, int p_77916_1_) {
      return checkFlag(p_77916_0_, p_77916_1_)?0:1;
   }

   public static int getPotionPrefixIndex(int p_77909_0_) {
      return getPotionPrefixIndexFlags(p_77909_0_, 5, 4, 3, 2, 1);
   }
   ...
   public static int getLiquidColor(int dataValue, boolean bypassCache) {
      Integer var2 = IntegerCache.getInteger(dataValue);
      if(!bypassCache) {
         ...
         return calcPotionLiquidColor(getPotionEffects(var2.intValue(), true));
      }
   }

   public static String getPotionPrefix(int p_77905_0_) {
      int var1 = getPotionPrefixIndex(p_77905_0_);
      return potionPrefixes[var1];
   }

   public static int getPotionEffect(boolean p_77904_0_, boolean p_77904_1_, boolean p_77904_2_, int p_77904_3_, int p_77904_4_, int p_77904_5_, int p_77904_6_) {
      int var7 = 0;
      if(p_77904_0_) {
   ...
   public static int countSetFlags(int p_77907_0_) {
      int var1;
   ...
   public static int parsePotionEffects(String p_77912_0_, int p_77912_1_, int p_77912_2_, int p_77912_3_) {
            ...
            if(var5 >= 0 && var5 < p_77912_2_) {
               ...
               for(int var15 = p_77912_1_; var15 < p_77912_2_; ++var15) {
                  ...
                  if(var16 >= 48 && var16 <= 57) {
                     ...
                     if(var8) {
                        var14 += getPotionEffect(var9, var7, var10, var11, var12, var13, p_77912_3_);
                        var9 = false;
                        var10 = false;
                        var6 = false;
                        var7 = false;
   ...
   public static int brewBitOperations(int p_77906_0_, int p_77906_1_, boolean p_77906_2_, boolean p_77906_3_, boolean p_77906_4_) {
      if(p_77906_4_) {
