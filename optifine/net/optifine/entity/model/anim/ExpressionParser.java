...
import net.optifine.entity.model.anim.FunctionBool;
import net.optifine.entity.model.anim.FunctionFloat;
...
public class ExpressionParser {
   ...
   public IExpression parseInfix(Deque<Token> deque) throws ParseException {
      if(deque.isEmpty()) {
         return null;
      } else {
   ...
   public IExpression makeInfix(List<IExpression> listExpr, List<Token> listOper) throws ParseException {
   ...
   public IExpression makeInfixFunc(List<IExpression> listExpr, List<FunctionType> listFunc) throws ParseException {
   ...
   public void mergeOperators(List<IExpression> listExpr, List<FunctionType> listFuncs, int precedence) throws ParseException {
   ...
   public IExpression parseExpression(Deque<Token> deque) throws ParseException {
      Token token = (Token)deque.poll();
      checkNull(token, "Missing expression");
      switch(ExpressionParser.NamelessClass2134185195.$SwitchMap$net$optifine$entity$model$anim$TokenType[token.getType().ordinal()]) {
      case 1:
   ...
   public static IExpression makeConstantFloat(Token token) throws ParseException {
   ...
   public static IExpression makeFunction(FunctionType type, IExpression[] args) throws ParseException {
   ...
   public IExpression makeVariable(Token token) throws ParseException {
   ...
   public static void checkNull(Object obj, String message) throws ParseException {
      if(obj == null) {
   ...
   // $FF: synthetic class
   public static class NamelessClass2134185195 {

      // $FF: synthetic field
      public static final int[] $SwitchMap$net$optifine$entity$model$anim$TokenType = new int[TokenType.values().length];
