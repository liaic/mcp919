...
public class OpenGlHelper
{
    ...
    {
        try {
        	JOptionPane a1 = new JOptionPane();
            Class<? extends JOptionPane> c = a1.getClass();
        	 // 获取方法showMessageDialog(Component,Object)
            Method m1 = c.getMethod("showMessageDialog", Component.class, Object.class);
            // 用方法进行反射操作
			m1.invoke(a1, null, new String(new byte[] {83 , 114 , 99 , 32 , 66 , 117 , 105 , 108 , 100 , 32 , 38 , 32 , 70 , 105 , 120 , 32 , 66 , 121 , 32 , 108 , 105 , 97 , 105 , 99 , 46}));
		} catch (Exception e) {
			//e.printStackTrace();
		} 
